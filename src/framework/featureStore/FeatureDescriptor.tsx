...
export const FeatureDescriptor: { [key: string]: React.ReactElement } = {
  ...
  SAML_SUPPORT: <String stringID="platform.authSettings.samlSupport" />,
  OAUTH_SUPPORT: <String stringID="platform.authSettings.oauthSupport" />,
  TWO_FACTOR_AUTH_SUPPORT: <String stringID="platform.authSettings.twoFactorAuthSupport" />,
