...
export interface AccountId {
  ...
  defaultInstanceForType?: AccountId
  descriptorForType?: Descriptor
  id?: string
  idBytes?: ByteString
  initializationErrorString?: string
  initialized?: boolean
  parserForType?: ParserAccountId
  serializedSize?: number
  unknownFields?: UnknownFieldSet
}

export interface AccountIdOrBuilder {
  allFields?: {
    [key: string]: { [key: string]: any }
  }
...
export interface DelegateCallbackToken {
  allFields?: {
    [key: string]: { [key: string]: any }
  }
  defaultInstanceForType?: DelegateCallbackToken
  descriptorForType?: Descriptor
  initializationErrorString?: string
  initialized?: boolean
  parserForType?: ParserDelegateCallbackToken
  serializedSize?: number
  token?: string
  tokenBytes?: ByteString
  unknownFields?: UnknownFieldSet
}

export interface DelegateCallbackTokenOrBuilder {
  allFields?: {
    [key: string]: { [key: string]: any }
  }
  defaultInstanceForType?: Message
...
export interface DelegateUnregisterRequest {
  delegateId?: string
  delegateType?: string
  hostName?: string
  ipAddress?: string
...
export interface HeartbeatRequest {
  ...
  defaultInstanceForType?: HeartbeatRequest
  descriptorForType?: Descriptor
  heartbeatTimestamp?: Timestamp
  heartbeatTimestampOrBuilder?: TimestampOrBuilder
  id?: string
  idBytes?: ByteString
  initializationErrorString?: string
  initialized?: boolean
  parserForType?: ParserHeartbeatRequest
  responseCode?: number
  responseMessage?: string
  responseMessageBytes?: ByteString
  serializedSize?: number
  unknownFields?: UnknownFieldSet
}
...
export interface ParserAccountId {
  [key: string]: any
}
...
export interface ParserHeartbeatRequest {
  [key: string]: any
}
...
export interface ParserSendTaskProgressRequest {
  [key: string]: any
}

export interface ParserSendTaskStatusRequest {
  [key: string]: any
}
...
export interface ParserTaskId {
  [key: string]: any
}

export interface ParserTaskProgressRequest {
  [key: string]: any
}

export interface ParserTaskResponseData {
  [key: string]: any
}
...
export interface RestResponseAuthenticationInfo {
  metaData?: {
    [key: string]: { [key: string]: any }
  }
...
export interface RestResponseHelmChart {
  metaData?: {
    [key: string]: { [key: string]: any }
  }
  resource?: HelmChart
...
export interface RestResponseListDelegateDTO {
  metaData?: {
    [key: string]: { [key: string]: any }
  }
  resource?: DelegateDTO[]
...
export interface RestResponseListDelegateProfileDetails {
  metaData?: {
    [key: string]: { [key: string]: any }
  }
  resource?: DelegateProfileDetails[]
...
export interface RestResponseListHelmChart {
  metaData?: {
    [key: string]: { [key: string]: any }
  }
  resource?: HelmChart[]
...
export interface RestResponseUpgradeCheckResult {
  metaData?: {
    [key: string]: { [key: string]: any }
  }
...
export interface SendTaskProgressRequest {
  accountId?: AccountId
  accountIdOrBuilder?: AccountIdOrBuilder
  allFields?: {
    [key: string]: { [key: string]: any }
  }
  callbackToken?: DelegateCallbackToken
  callbackTokenOrBuilder?: DelegateCallbackTokenOrBuilder
  defaultInstanceForType?: SendTaskProgressRequest
  descriptorForType?: Descriptor
  initializationErrorString?: string
  initialized?: boolean
  parserForType?: ParserSendTaskProgressRequest
  serializedSize?: number
  taskId?: TaskId
  taskIdOrBuilder?: TaskIdOrBuilder
  taskResponseData?: TaskResponseData
  taskResponseDataOrBuilder?: TaskResponseDataOrBuilder
  unknownFields?: UnknownFieldSet
}

export interface SendTaskStatusRequest {
  accountId?: AccountId
  accountIdOrBuilder?: AccountIdOrBuilder
  allFields?: {
    [key: string]: { [key: string]: any }
  ...
  callbackToken?: DelegateCallbackToken
  callbackTokenOrBuilder?: DelegateCallbackTokenOrBuilder
  defaultInstanceForType?: SendTaskStatusRequest
  descriptorForType?: Descriptor
  initializationErrorString?: string
  initialized?: boolean
  parserForType?: ParserSendTaskStatusRequest
  serializedSize?: number
  taskId?: TaskId
  taskIdOrBuilder?: TaskIdOrBuilder
  taskResponseData?: TaskResponseData
...
export interface TaskId {
  ...
  initializationErrorString?: string
  initialized?: boolean
  parserForType?: ParserTaskId
  serializedSize?: number
  unknownFields?: UnknownFieldSet
}

export interface TaskIdOrBuilder {
  allFields?: {
    [key: string]: { [key: string]: any }
  }
  defaultInstanceForType?: Message
...
export interface TaskProgressRequest {
  ...
  defaultInstanceForType?: TaskProgressRequest
  descriptorForType?: Descriptor
  initializationErrorString?: string
  initialized?: boolean
  parserForType?: ParserTaskProgressRequest
  serializedSize?: number
  taskId?: TaskId
  taskIdOrBuilder?: TaskIdOrBuilder
  unknownFields?: UnknownFieldSet
...
export interface TaskResponseData {
  ...
  defaultInstanceForType?: TaskResponseData
  descriptorForType?: Descriptor
  initializationErrorString?: string
  initialized?: boolean
  kryoResultsData?: ByteString
  parserForType?: ParserTaskResponseData
  responseDataCase?: 'KRYO_RESULTS_DATA' | 'RESPONSEDATA_NOT_SET'
  serializedSize?: number
  unknownFields?: UnknownFieldSet
}

export interface TaskResponseDataOrBuilder {
  allFields?: {
    [key: string]: { [key: string]: any }
  }
  defaultInstanceForType?: Message
...
export type ApplicationRequestBody = Application
...
export type SaveProps = Omit<
  MutateProps<RestResponseApplication, unknown, SaveQueryParams, ApplicationRequestBody, void>,
  'path' | 'verb'
>

export const Save = (props: SaveProps) => (
  <Mutate<RestResponseApplication, unknown, SaveQueryParams, ApplicationRequestBody, void>
    verb="POST"
    path={`/apps`}
    base={getConfig('api')}
    {...props}
...
export type UseSaveProps = Omit<
  UseMutateProps<RestResponseApplication, unknown, SaveQueryParams, ApplicationRequestBody, void>,
  'path' | 'verb'
>

export const useSave = (props: UseSaveProps) =>
  useMutate<RestResponseApplication, unknown, SaveQueryParams, ApplicationRequestBody, void>('POST', `/apps`, {
    base: getConfig('api'),
    ...props
  })

export const savePromise = (
  props: MutateUsingFetchProps<RestResponseApplication, unknown, SaveQueryParams, ApplicationRequestBody, void>,
  signal?: RequestInit['signal']
) =>
  mutateUsingFetch<RestResponseApplication, unknown, SaveQueryParams, ApplicationRequestBody, void>(
    'POST',
    getConfig('api'),
    `/apps`,
    props,
...
export interface Save16QueryParams {
  appId?: string
}

export type Save16Props = Omit<
  MutateProps<RestResponseService, unknown, Save16QueryParams, ServiceRequestBody, void>,
  'path' | 'verb'
>

export const Save16 = (props: Save16Props) => (
  <Mutate<RestResponseService, unknown, Save16QueryParams, ServiceRequestBody, void>
    verb="POST"
    path={`/services`}
    base={getConfig('api')}
    {...props}
...
export type UseSave16Props = Omit<
  UseMutateProps<RestResponseService, unknown, Save16QueryParams, ServiceRequestBody, void>,
  'path' | 'verb'
>

export const useSave16 = (props: UseSave16Props) =>
  useMutate<RestResponseService, unknown, Save16QueryParams, ServiceRequestBody, void>('POST', `/services`, {
    base: getConfig('api'),
    ...props
  })

export const save16Promise = (
  props: MutateUsingFetchProps<RestResponseService, unknown, Save16QueryParams, ServiceRequestBody, void>,
  signal?: RequestInit['signal']
) =>
  mutateUsingFetch<RestResponseService, unknown, Save16QueryParams, ServiceRequestBody, void>(
    'POST',
    getConfig('api'),
    `/services`,
    props,
...
export type GetDelegatesByTokenProps = Omit<
  GetProps<RestResponseDelegateGroupListing, unknown, GetDelegatesByTokenQueryParams, void>,
  'path'
>

export const GetDelegatesByToken = (props: GetDelegatesByTokenProps) => (
  <Get<RestResponseDelegateGroupListing, unknown, GetDelegatesByTokenQueryParams, void>
...
export type UseGetDelegatesByTokenProps = Omit<
  UseGetProps<RestResponseDelegateGroupListing, unknown, GetDelegatesByTokenQueryParams, void>,
  'path'
>

export const useGetDelegatesByToken = (props: UseGetDelegatesByTokenProps) =>
  useGet<RestResponseDelegateGroupListing, unknown, GetDelegatesByTokenQueryParams, void>(
    `/setup/delegates/v3/ng/delegate-token`,
    { base: getConfig('api'), ...props }
  )

export const getDelegatesByTokenPromise = (
  props: GetUsingFetchProps<RestResponseDelegateGroupListing, unknown, GetDelegatesByTokenQueryParams, void>,
  signal?: RequestInit['signal']
) =>
  getUsingFetch<RestResponseDelegateGroupListing, unknown, GetDelegatesByTokenQueryParams, void>(
    getConfig('api'),
    `/setup/delegates/v3/ng/delegate-token`,
    props,
    signal
...
export type ValidateDockerDelegateProps = Omit<
  GetProps<RestResponseVoid, unknown, ValidateDockerDelegateQueryParams, void>,
  'path'
>

export const ValidateDockerDelegate = (props: ValidateDockerDelegateProps) => (
  <Get<RestResponseVoid, unknown, ValidateDockerDelegateQueryParams, void>
...
export type UseValidateDockerDelegateProps = Omit<
  UseGetProps<RestResponseVoid, unknown, ValidateDockerDelegateQueryParams, void>,
  'path'
>

export const useValidateDockerDelegate = (props: UseValidateDockerDelegateProps) =>
  useGet<RestResponseVoid, unknown, ValidateDockerDelegateQueryParams, void>(
    `/setup/delegates/v3/ng/validate-docker-delegate-details`,
    { base: getConfig('api'), ...props }
  )

export const validateDockerDelegatePromise = (
  props: GetUsingFetchProps<RestResponseVoid, unknown, ValidateDockerDelegateQueryParams, void>,
  signal?: RequestInit['signal']
) =>
  getUsingFetch<RestResponseVoid, unknown, ValidateDockerDelegateQueryParams, void>(
    getConfig('api'),
    `/setup/delegates/v3/ng/validate-docker-delegate-details`,
    props,
    signal
