...
import { DirectPushStepData, DirectPushStepEditProps } from './DirectPushStepEdit'
import stepCss from '@pipeline/components/PipelineSteps/Steps/Steps.module.scss'

export default function DirectPushStepInputSet(
  props: DirectPushStepEditProps & { formik?: FormikContextType<DirectPushStepData> }
): React.ReactElement {
  ...
  return (
    <>
      ...
      {isValueRuntimeInput(get(template, 'spec.codeDirectory')) && (
        <TextFieldInputSetView
          name={`${path}.spec.codeDirectory`}
          label={getString('idp.directPushStep.codeDirectory')}
          disabled={readonly}
          multiTextInputProps={{
            allowableTypes,
            expressions
