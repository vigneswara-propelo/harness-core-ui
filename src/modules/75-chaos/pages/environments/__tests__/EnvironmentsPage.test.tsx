...
describe('EnvironmentsPage', () => {
  ...
  const renderComponent = (): RenderResult => {
    return render(
      <TestWrapper
        path="/account/:accountId/chaos/orgs/:orgIdentifier/projects/:projectIdentifier/environments"
  ...
  test('Should allow deleting', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('chaos.environments.delete.toastMessage')).toBeInTheDocument()
    })
  })
  ...
  test('Should close Delete env modal if user cancels deletion', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.queryByText('chaos.environments.delete.title')).not.toBeInTheDocument()
    })
  })
