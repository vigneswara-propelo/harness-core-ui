...
import { GitCloneStep as GitCloneStepComponent } from './GitCloneStep'

factory.registerStep(new GitCloneStepComponent())

export default {
  title: 'Pipelines / Pipeline Steps / GitCloneStep',
...
export const GitCloneStep: Story<Omit<TestStepWidgetProps, 'factory'>> = args => {
