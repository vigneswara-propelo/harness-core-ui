...
import { GHAPluginStep } from '../GHAPluginStep'
...
describe('Plugin Step', () => {
  ...
  describe('Edit View', () => {
    test('should render properly', () => {
      const { container } = render(
        <TestStepWidget initialValues={{}} type={StepType.GHAPlugin} stepViewType={StepViewType.Edit} />
      )
    ...
    test('renders runtime inputs', async () => {
      const initialValues = {
        identifier: 'GHA_Plugin_Step',
        name: 'GHA Plugin Step',
  ...
  describe('InputSet View', () => {
    test('should render properly', () => {
      const { container } = render(
        <TestStepWidget initialValues={{}} type={StepType.GHAPlugin} stepViewType={StepViewType.InputSet} />
      )
