...
import type { GARStepProps } from './GARStep'
import { CIStep } from '../CIStep/CIStep'
import { ArtifactStepCommon } from '../CIStep/ArtifactStepCommon'
import css from '@pipeline/components/PipelineSteps/Steps/Steps.module.scss'

export const GARStepInputSetBasic: React.FC<GARStepProps> = ({
  template,
  path,
  readonly,
  allowableTypes,
      ...
      <CIStep
        ...
        enableFields={{
          ...(getMultiTypeFromValue(template?.spec?.connectorRef) === MultiTypeInputType.RUNTIME && {
            'spec.connectorRef': {
              label: { labelKey: 'pipelineSteps.gcpConnectorLabel', tooltipId: 'garConnector' },
              type: Connectors.GCP
            }
          }),
...
const GARStepInputSet = connect(GARStepInputSetBasic)
export { GARStepInputSet }
