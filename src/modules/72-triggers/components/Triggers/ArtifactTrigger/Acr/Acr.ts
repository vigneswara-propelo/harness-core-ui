...
export class Acr extends ArtifactTrigger<ArtifactTriggerValues> {
  protected type: TriggerArtifactType = 'Acr'
  protected triggerDescription: keyof StringsMap = 'pipeline.ACR.name'
