...
const RemoteEvaluationModal = lazy(() => import('governance/EvaluationModal'))

export const PolicyManagementEvaluationModal: FC<any> = (props: any) => {
  const { path }: RouteMatch = useRouteMatch()
  return (
    <ChildComponentMounter<GovernanceCustomMicroFrontendProps>
      ChildComponent={RemoteEvaluationModal}
