...
import { ETMonitoredServices } from '@et/pages/ETMonitoredServices'
...
describe('Unit tests for ETMonitoredServices', () => {
  test('Verify ETMonitoredServices page renders and matches snapshot', async () => {
    const container = render(<WrapperComponent />)
    expect(container).toMatchSnapshot()
  })

  test('Verify ETMonitoredServices page enabled is not empty ', async () => {
