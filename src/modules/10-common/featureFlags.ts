...
export enum FeatureFlag {
  ...
  SPG_NG_GITHUB_WEBHOOK_AUTHENTICATION = 'SPG_NG_GITHUB_WEBHOOK_AUTHENTICATION',
  SRM_ENABLE_HEALTHSOURCE_AWS_PROMETHEUS = 'SRM_ENABLE_HEALTHSOURCE_AWS_PROMETHEUS',
  ...
  CLOUD_COST_GOVERNANCE_UI = 'CLOUD_COST_GOVERNANCE_UI'
}
