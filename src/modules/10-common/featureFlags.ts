...
export enum FeatureFlag {
  ...
  SSCA_ARTIFACTS_ENABLED = 'SSCA_ARTIFACTS_ENABLED',
  SSCA_MANAGER_ENABLED = 'SSCA_MANAGER_ENABLED',
  ...
  STO_AI_ENHANCED_REMEDIATIONS = 'STO_AI_ENHANCED_REMEDIATIONS',
  STO_ALL_ISSUES_PAGE = 'STO_ALL_ISSUES_PAGE',
  STO_BASELINE_REGEX = 'STO_BASELINE_REGEX',
  STO_DROPDOWN_FILTERS = 'STO_DROPDOWN_FILTERS',
  STO_EXEMPTION_DETAILS = 'STO_EXEMPTION_DETAILS',
  ...
  CHAOS_NEW_ENVIRONMENTS_PAGE = 'CHAOS_NEW_ENVIRONMENTS_PAGE',
  ...
  CDS_ENABLE_GCS_ARTIFACT_TYPE = 'CDS_ENABLE_GCS_ARTIFACT_TYPE',
