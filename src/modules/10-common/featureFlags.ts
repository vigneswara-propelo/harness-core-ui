...
export enum FeatureFlag {
  ...
  SSCA_ENFORCEMENT_OPA = 'SSCA_ENFORCEMENT_OPA',
  CDS_K8S_TRAFFIC_ROUTING_NG = 'CDS_K8S_TRAFFIC_ROUTING_NG',
  SSCA_SBOM_DRIFT = 'SSCA_SBOM_DRIFT',
  ...
  CDS_CF_TOKEN_AUTH = 'CDS_CF_TOKEN_AUTH',
  ...
  STO_BASELINE_DEFAULTING = 'STO_BASELINE_DEFAULTING',
  ...
  CCM_ENABLE_GCP_CLOUD_ASSET_GOVERNANCE_UI = 'CCM_ENABLE_GCP_CLOUD_ASSET_GOVERNANCE_UI',
  ...
  PL_CENTRAL_CERTIFICATES_MANAGEMENT = 'PL_CENTRAL_CERTIFICATES_MANAGEMENT',
  ...
  CDS_USER_CD_LICENSE_VIEW = 'CDS_USER_CD_LICENSE_VIEW',
  PIE_INPUTSET_RBAC_PERMISSIONS = 'PIE_INPUTSET_RBAC_PERMISSIONS',
  CI_SECURE_TUNNEL = 'CI_SECURE_TUNNEL',
  SRM_ENABLE_MS_TEMPLATE_RECONCILIATION = 'SRM_ENABLE_MS_TEMPLATE_RECONCILIATION',
  SEI_NEW_ONBOARDING_INTEGRATIONS = 'SEI_NEW_ONBOARDING_INTEGRATIONS',
  SSCA_REMEDIATION_TRACKER = 'SSCA_REMEDIATION_TRACKER',
  STO_AUTO_TARGET_NAME_VARIANT = 'STO_AUTO_TARGET_NAME_VARIANT',
  IDP_ENABLE_CUSTOM_PLUGINS = 'IDP_ENABLE_CUSTOM_PLUGINS'
}
