...
jest.mock('services/cd-ng', () => ({
  getAllServicesPromise: jest.fn().mockImplementation(() => {
...
describe('service dropdown test', () => {
  ...
  test('test when data is not defined', () => {
    serviceListPromiseMock = jest.fn().mockImplementation(() => {
    ...
    expect(queryByText('serviceDropdown')).not.toBeNull()
  })
})
