...
export enum PermissionIdentifier {
  ...
  VIEW_CHAOS_WORKFLOW = 'chaos_chaosworkflow_view',
  EDIT_CHAOS_WORKFLOW = 'chaos_chaosworkflow_edit',
  DELETE_CHAOS_WORKFLOW = 'chaos_chaosworkflow_delete',
  VIEW_CHAOS_AGENT = 'chaos_chaosagent_view',
  EDIT_CHAOS_AGENT = 'chaos_chaosagent_edit',
  DELETE_CHAOS_AGENT = 'chaos_chaosagent_delete',
