...
import type { PrismaCloudStepProps } from './PrismaCloudStep'
import css from '@pipeline/components/PipelineSteps/Steps/Steps.module.scss'

export const PrismaCloudStepInputSetBasic: React.FC<PrismaCloudStepProps> = ({
  template,
  path,
  readonly,
  stepViewType,
...
const PrismaCloudStepInputSet = connect(PrismaCloudStepInputSetBasic)
export { PrismaCloudStepInputSet }
