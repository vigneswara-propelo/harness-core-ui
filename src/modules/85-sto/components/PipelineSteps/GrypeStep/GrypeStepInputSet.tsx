...
import type { GrypeStepProps } from './GrypeStep'
import { getInputSetFieldName, inputSetFields } from '../constants'
import SecurityField from '../SecurityField'
import css from '@pipeline/components/PipelineSteps/Steps/Steps.module.scss'

export const GrypeStepInputSetBasic: React.FC<GrypeStepProps> = ({
  template,
  path,
  readonly,
  stepViewType,
...
const GrypeStepInputSet = connect(GrypeStepInputSetBasic)
export { GrypeStepInputSet }
