...
import { BurpStep, BurpStepData } from '../BurpStep'
...
describe('Burp Step', () => {
  ...
  describe('Edit View', () => {
    test('should render properly', () => {
      const { container } = render(
        <TestStepWidget initialValues={{}} type={StepType.Burp} stepViewType={StepViewType.Edit} />
      )

      expect(container).toMatchSnapshot()
    })

    test('renders runtime inputs - Extraction Instance', async () => {
      const initialValues = {
        identifier: 'My_Burp_Step',
        name: 'My Burp Step',
  ...
  describe('InputSet View', () => {
    test('should render properly', () => {
      const { container } = render(
        <TestStepWidget initialValues={{}} type={StepType.Burp} stepViewType={StepViewType.InputSet} />
      )
  ...
  test('validates input set correctly', () => {
    ...
    const result = new BurpStep().validateInputSet({
      data,
      template: data,
