...
import type { SonarqubeStepProps } from './SonarqubeStep'
import { getInputSetFieldName } from '../constants'
import { InputSetFields } from '../SecurityFields'
import css from '@pipeline/components/PipelineSteps/Steps/Steps.module.scss'

export const SonarqubeStepInputSetBasic: React.FC<SonarqubeStepProps> = ({
  template,
  path,
  readonly,
  stepViewType,
...
const SonarqubeStepInputSet = connect(SonarqubeStepInputSetBasic)
export { SonarqubeStepInputSet }
