...
import { SysdigStep, SysdigStepData } from '../SysdigStep'

jest.mock('@common/components/YAMLBuilder/YamlBuilder')

describe('Sysdig Step', () => {
  beforeAll(() => {
  ...
  describe('Edit View', () => {
    test('should render properly', () => {
      const { container } = render(
        <TestStepWidget initialValues={{}} type={StepType.Sysdig} stepViewType={StepViewType.Edit} />
      )
      ...
      const initialValues = {
        ...
        spec: {
          ...
          image: {
            ...
            access_token: '<+secrets.getValue("your_sysdig_token_secret")>',
  ...
  describe('InputSet View', () => {
    test('should render properly', () => {
      const { container } = render(
        <TestStepWidget initialValues={{}} type={StepType.Sysdig} stepViewType={StepViewType.InputSet} />
      )
  ...
  test('validates input set correctly', () => {
    ...
    const result = new SysdigStep().validateInputSet({
      data,
      template: data,
