...
export interface MetasploitStepVariablesProps {
  initialValues: MetasploitStepData
  stageIdentifier: string
  onUpdate?(data: MetasploitStepData): void
  metadataMap: Required<VariableMergeServiceResponse>['metadataMap']
  variablesData: MetasploitStepData
}

export const MetasploitStepVariables: React.FC<MetasploitStepVariablesProps> = ({
  variablesData,
  metadataMap,
  initialValues
