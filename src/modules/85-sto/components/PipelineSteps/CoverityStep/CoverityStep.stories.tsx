...
import { CoverityStep as CoverityStepComponent } from './CoverityStep'

factory.registerStep(new CoverityStepComponent())

export default {
  title: 'Pipelines / Pipeline Steps / CoverityStep',
...
export const CoverityStep: Story<Omit<TestStepWidgetProps, 'factory'>> = args => {
