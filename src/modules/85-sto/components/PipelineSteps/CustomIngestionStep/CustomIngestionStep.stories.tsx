...
import { CustomIngestionStep as CustomIngestionStepComponent } from './CustomIngestionStep'

factory.registerStep(new CustomIngestionStepComponent())

export default {
  title: 'Pipelines / Pipeline Steps / CustomIngestionStep',
...
export const CustomIngestionStep: Story<Omit<TestStepWidgetProps, 'factory'>> = args => {
