...
import { AWSSecurityHubStep as AWSSecurityHubStepComponent } from './AWSSecurityHubStep'

factory.registerStep(new AWSSecurityHubStepComponent())

export default {
  title: 'Pipelines / Pipeline Steps / AWSSecurityHubStep',
...
export const AWSSecurityHubStep: Story<Omit<TestStepWidgetProps, 'factory'>> = args => {
