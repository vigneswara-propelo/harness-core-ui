...
import { BlackduckStep as BlackduckStepComponent } from './BlackduckStep'

factory.registerStep(new BlackduckStepComponent())

export default {
  title: 'Pipelines / Pipeline Steps / BlackduckStep',
...
export const BlackduckStep: Story<Omit<TestStepWidgetProps, 'factory'>> = args => {
