...
import { AquaSecurityStep as AquaSecurityStepComponent } from './AquaSecurityStep'

factory.registerStep(new AquaSecurityStepComponent())

export default {
  title: 'Pipelines / Pipeline Steps / AquaSecurityStep',
...
export const AquaSecurityStep: Story<Omit<TestStepWidgetProps, 'factory'>> = args => {
