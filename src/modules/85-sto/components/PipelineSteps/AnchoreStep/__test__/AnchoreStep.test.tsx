...
import { AnchoreStep, AnchoreStepData } from '../AnchoreStep'

jest.mock('@common/components/YAMLBuilder/YamlBuilder')

describe('Anchore Step', () => {
  beforeAll(() => {
  ...
  describe('Edit View', () => {
    test('should render properly', () => {
      const { container } = render(
        <TestStepWidget initialValues={{}} type={StepType.Anchore} stepViewType={StepViewType.Edit} />
      )
    ...
    test('renders runtime inputs - Ingestion Container', async () => {
      const initialValues = {
        identifier: 'My_AnchoreEnterprise_Step',
        name: 'My Anchore Step',
    ...
    test('edit mode works', async () => {
      const initialValues = {
        identifier: 'My_AnchoreEnterprise_Stp',
        name: 'My Anchore Step',
        ...
        spec: {
          ...
          auth: {
            ...
            access_token: '<+secrets.getValue("your_AnchoreEnterprise_token_secret")>'
          },
          config: 'default',
          mode: 'orchestration',
          settings: {
  ...
  describe('InputSet View', () => {
    test('should render properly', () => {
      const { container } = render(
        <TestStepWidget initialValues={{}} type={StepType.Anchore} stepViewType={StepViewType.InputSet} />
      )
  ...
  test('validates input set correctly', () => {
    ...
    const result = new AnchoreStep().validateInputSet({
      data,
      template: data,
