...
describe('Brakeman Step', () => {
  ...
  describe('Edit View', () => {
    test('should render properly', () => {
      const { container } = render(
        <TestStepWidget initialValues={{}} type={StepType.Brakeman} stepViewType={StepViewType.Edit} />
      )
    ...
    test('renders runtime inputs - Ingestion Container', async () => {
      const initialValues = {
        identifier: 'My_Brakeman_Step',
        name: 'My Brakeman Step',
  ...
  describe('InputSet View', () => {
    test('should render properly', () => {
      const { container } = render(
        <TestStepWidget initialValues={{}} type={StepType.Brakeman} stepViewType={StepViewType.InputSet} />
      )
  ...
  test('validates input set correctly', () => {
    ...
    const result = new BrakemanStep().validateInputSet({
      data,
      template: data,
