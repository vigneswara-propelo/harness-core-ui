...
import { NmapStep, NmapStepData } from '../NmapStep'
...
describe('Nmap Step', () => {
  ...
  describe('Edit View', () => {
    test('should render properly', () => {
      const { container } = render(
        <TestStepWidget initialValues={{}} type={StepType.Nmap} stepViewType={StepViewType.Edit} />
      )
  ...
  describe('InputSet View', () => {
    test('should render properly', () => {
      const { container } = render(
        <TestStepWidget initialValues={{}} type={StepType.Nmap} stepViewType={StepViewType.InputSet} />
      )
  ...
  test('validates input set correctly', () => {
    ...
    const result = new NmapStep().validateInputSet({
      data,
      template: data,
