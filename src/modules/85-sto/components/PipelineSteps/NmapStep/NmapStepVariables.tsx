...
export interface NmapStepVariablesProps {
  initialValues: NmapStepData
  stageIdentifier: string
  onUpdate?(data: NmapStepData): void
  metadataMap: Required<VariableMergeServiceResponse>['metadataMap']
  variablesData: NmapStepData
}

export const NmapStepVariables: React.FC<NmapStepVariablesProps> = ({ variablesData, metadataMap, initialValues }) => (
