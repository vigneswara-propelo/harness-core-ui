...
import { getConnectorDisplayName, getIconByType } from '@platform/connectors/pages/connectors/utils/ConnectorUtils'
        ...
        return (
          <section className={css.limitWarningTooltipCtn}>
            <FeatureWarningTooltip
              featureName={FeatureIdentifier.CCM_K8S_CLUSTERS}
              warningMessage={getString('platform.connectors.ceK8.featureWarning', { count, limit })}
            />
          </section>
        )
      }
