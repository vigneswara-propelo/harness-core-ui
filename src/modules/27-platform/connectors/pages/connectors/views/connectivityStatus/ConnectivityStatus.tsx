...
import { StepIndex, STEP } from '@platform/connectors/common/ConnectorTestConnection/ConnectorTestConnection'
  ...
  const renderTooltip = () => {
    return (
      <WarningTooltip
        ...
        errorDeatailsText={getString('platform.connectors.testConnectionStep.errorDetails')}
  ...
  if (testing) {
    return (
      <Layout.Horizontal>
        ...
        <Text style={{ margin: 8 }}>{getString('platform.connectors.testInProgress')}</Text>
      </Layout.Horizontal>
    )
  }
