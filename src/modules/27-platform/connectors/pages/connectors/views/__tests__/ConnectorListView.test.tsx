...
import {
  ...
  statisticsMockData,
  filters
} from '@platform/connectors/pages/connectors/__tests__/mockData'
...
describe('Connectors List Test', () => {
  ...
  test.skip('Click on Test button with result error', async () => {
    ...
    expect(container).toMatchSnapshot()
    expect(getByText('platform.connectors.testInProgress')).toBeDefined()
  ...
  test('Edit and delete methods should be called with correct data', async () => {
    ...
    const deleteText = `platform.connectors.confirmDelete `
