...
import ActivityHistory from '@platform/connectors/components/activityHistory/ActivityHistory/ActivityHistory'
        ...
        tabList={[
          {
            ...
            panel: data.connector?.type ? (
              ...
              <NoDataCard message={getString('platform.connectors.connectorNotFound')} icon="question" />
            )
          },
          {
