...
import testConnectionSuccess from '@platform/connectors/common/ConnectorTestConnection/__tests__/mockData/test-connection-success.json'
import delegateNameresponse from '@platform/connectors/common/ConnectorTestConnection/__tests__/mockData/delegate-name-response-error.json'

import {
  ManualK8s,
  K8WithInheritFromDelegate
} from '@platform/connectors/common/ConnectorTestConnection/__tests__/mockData/connectorsMock'
...
describe('Test Connection', () => {
  test('render test connection', () => {
    ...
    expect(getByText('platform.connectors.stepThreeName')).toBeDefined()
