...
import { mockResponse, mockSecret } from '@platform/connectors/components/CreateConnector/HelmRepoConnector/helmMock'
...
describe('Create Helm Connector  Wizard', () => {
  test('Should render form', async () => {
    ...
    expect(getByText('platform.connectors.title.ociHelmConnector')).toBeDefined()
