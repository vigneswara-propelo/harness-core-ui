  ...
  return (
    <>
      <Text color={Color.GREY_800} font={{ variation: FontVariation.BODY }} padding={{ bottom: 'small' }}>
        {getString('platform.connectors.ceAzure.existingExports.instruction', {
      ...
      <Container className={css.existingBeTable}>
        <ExpandingSearchInput
          ...
          placeholder={getString('platform.connectors.ceAzure.existingExports.searchBillingReports')}
        />
        <Table
          data={billingReports}
          ...
          columns={[
            {
              accessor: 'tenantId',
              Header: getString('platform.connectors.ceAzure.existingExports.tenantId')
            },
            {
              accessor: 'billingExportSpec.storageAccountName',
              Header: getString('platform.connectors.ceAzure.billing.storageAccountName')
            },
            {
              accessor: 'billingExportSpec.containerName',
              Header: getString('platform.connectors.ceAzure.billing.containerName')
            },
            {
              accessor: 'billingExportSpec.directoryName',
              Header: getString('platform.connectors.ceAzure.billing.directoryName')
            },
            {
              accessor: 'billingExportSpec.reportName',
              Header: getString('platform.connectors.ceAzure.billing.reportName')
            },
            {
              accessor: 'billingExportSpec.subscriptionId',
              Header: getString('platform.connectors.ceAzure.existingExports.subscriptionId')
            }
          ]}
        />
      </Container>
