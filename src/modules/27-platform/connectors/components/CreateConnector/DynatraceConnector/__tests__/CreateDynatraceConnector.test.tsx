...
describe('Unit tests for CreateDynatraceConnector', () => {
  ...
  test('Ensure validation works', async () => {
    ...
    await waitFor(() => expect(getByText('platform.connectors.dynatrace.urlValidation')).not.toBeNull())
    expect(getByText('platform.connectors.apiTokenValidation')).not.toBeNull()
