...
import { CCM_CONNECTOR_SAVE_EVENT, CE_GCP_CONNECTOR_CREATION_EVENTS } from '@platform/connectors/trackingConstants'
...
const TestConnection: React.FC<TestConnectionProps> = props => {
  ...
  const steps: string[] = [getString('platform.connectors.ceGcp.testConnection.step1')]
  ...
  return (
    <Layout.Vertical className={css.stepContainer}>
      ...
      <Heading level={2} className={css.header}>
        {getString('platform.connectors.ceGcp.testConnection.heading')}
      </Heading>
