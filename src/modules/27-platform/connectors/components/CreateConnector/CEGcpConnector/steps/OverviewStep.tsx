...
const OverviewStep: React.FC<OverviewProps> = props => {
  ...
  return (
    <Layout.Vertical className={css.stepContainer}>
      ...
      >
        {getString('platform.connectors.ceGcp.overview.heading')}
      </Text>
      <div style={{ flex: 1 }}>
                ...
                <Container className={css.main} style={{ width: '65%' }}>
                  <Layout.Vertical spacing="large">
                    ...
                    <FormInput.Text
                      ...
                      name={'projectId'}
                      label={getString('platform.connectors.ceGcp.overview.projectIdLabel')}
                    />
                    ...
                    <Layout.Vertical spacing="large">
                      <div style={{ color: 'red' }}>
                        ...
                        <span style={{ fontSize: 'var(--font-size-normal)' }}>
                          {getString('platform.connectors.ceGcp.overview.alreadyExist')}
                        </span>
                      </div>
                      <div>
                        <Icon name="info" style={{ paddingRight: 5 }}></Icon>
                        {getString('platform.connectors.ceGcp.overview.alreadyExistInfo', {
                          projectId,
