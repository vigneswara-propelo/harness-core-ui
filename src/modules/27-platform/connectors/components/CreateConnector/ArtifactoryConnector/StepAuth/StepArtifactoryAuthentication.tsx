...
import { setupArtifactoryFormData, useGetHelpPanel } from '@platform/connectors/pages/connectors/utils/ConnectorUtils'
            ...
            <Layout.Vertical padding={{ top: 'large', bottom: 'large' }} className={cx(css.secondStep, formClassName)}>
              <Container className={css.formRow}>
                <FormInput.Text
                  ...
                  label={getString('platform.connectors.artifactory.artifactoryServerUrl')}
                />
              </Container>
