...
describe('Create Secret Manager Wizard', () => {
  ...
  test('Should render previous step for edit', async () => {
    ...
    await waitFor(() => expect(queryByText('platform.connectors.gcpSecretManager.gcpSMSecretFile')).toBeTruthy())
    // step 2 - details  step
    expect(queryByText('platform.connectors.GCP.delegateOutClusterInfo')).toBeTruthy()
    expect(queryByText('platform.connectors.gcpSecretManager.gcpSMSecretFile')).toBeTruthy()
    await act(async () => {
