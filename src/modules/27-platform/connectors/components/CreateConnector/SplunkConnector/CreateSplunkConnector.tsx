...
import { buildSplunkPayload } from '@platform/connectors/pages/connectors/utils/ConnectorUtils'
      ...
      {formikProps => (
        <FormikForm className={css.connectionForm}>
          <Layout.Vertical spacing="medium" className={css.appDContainer}>
            <StepDetailsHeader connectorTypeLabel={getString('platform.connectors.splunkLabel')} />
            ...
            {formikProps.values.authType === AuthTypes.BEARER_TOKEN && (
              <SecretInput name={'tokenRef'} label={getString('platform.connectors.bearerToken')} scope={scope} />
            )}
          </Layout.Vertical>
          <Layout.Horizontal spacing="large">
            ...
            <Button
              ...
              type="submit"
              text={getString('platform.connectors.connectAndSave')}
            />
          </Layout.Horizontal>
        </FormikForm>
      )}
