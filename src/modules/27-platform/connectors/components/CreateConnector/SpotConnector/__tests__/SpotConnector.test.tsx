...
describe('<SpotConnector />', () => {
  ...
  test('new connector creation step 1', async () => {
    ...
    expect(getByText('platform.connectors.selectConnectivityMode')).toBeInTheDocument()
  ...
  test('new connector creation step 2', async () => {
    ...
    expect(getByText('authentication')).toBeInTheDocument()
    expect(getByText('platform.connectors.spotAccountId')).toBeInTheDocument()
    expect(getByText('platform.connectors.apiToken')).toBeInTheDocument()
