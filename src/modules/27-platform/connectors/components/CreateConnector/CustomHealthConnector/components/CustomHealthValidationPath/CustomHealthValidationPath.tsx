    ...
    <Formik<CustomHealthValidationPathFormFields>
      ...
      validationSchema={Yup.object().shape({
        [CustomHealthValidationPathFieldNames.REQUEST_METHOD]: Yup.string().required(
          getString('platform.connectors.customHealth.requestMethod')
        ),
        [CustomHealthValidationPathFieldNames.VALIDATION_PATH]: Yup.string()
          .nullable()
          .required(getString('platform.connectors.customHealth.validationPath')),
        [CustomHealthValidationPathFieldNames.REQUEST_BODY]: Yup.string()
          ...
          .when(CustomHealthValidationPathFieldNames.REQUEST_METHOD, {
            ...
            then: Yup.string().trim().required(getString('platform.connectors.customHealth.requestBody'))
          })
      })}
    ...
    >
      {formik => (
        <FormikForm>
          ...
          />
          <FormInput.Text
            label={getString('platform.connectors.validationPath')}
