...
import { setupAwsSecretManagerFormData } from '@platform/connectors/pages/connectors/utils/ConnectorUtils'
import {
              ...
              <Container margin={{ top: 'medium', bottom: 'xxlarge' }} className={css.container}>
                ...
                {formik.values?.credType === credTypeOptions[2].value && (
                  <>
                    ...
                    <FormInput.Text name="externalId" label={getString('platform.connectors.aws.externalId')} />
                    <FormInput.Text
