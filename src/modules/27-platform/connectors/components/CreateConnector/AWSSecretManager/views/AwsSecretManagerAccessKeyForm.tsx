...
import { AwsSecretManagerConfigFormData, CredTypeValues } from '@platform/connectors/interfaces/ConnectorInterface'
    ...
    <>
      ...
      {formik.values?.credType === CredTypeValues.ManualConfig && (
        <>
          <SecretInput
            name="accessKey"
            label={getString('platform.connectors.awsKms.accessKeyLabel')}
            connectorTypeContext={Connectors.AWS_SECRET_MANAGER}
          />
          <SecretInput
            name="secretKey"
            label={getString('platform.connectors.awsKms.secretKeyLabel')}
            connectorTypeContext={Connectors.AWS_SECRET_MANAGER}
          />
        </>
      )}
      <FormInput.Text
        ...
        label={getString('platform.connectors.awsSecretManager.secretNamePrefix')}
      />
      {loading ? (
