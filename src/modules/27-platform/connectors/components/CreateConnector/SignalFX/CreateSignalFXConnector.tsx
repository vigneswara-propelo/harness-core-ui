...
import { buildSignalFXPayload } from '@platform/connectors/pages/connectors/utils/ConnectorUtils'
...
export function CreateSignalFXConnector(props: ConnectionConfigProps): JSX.Element {
  ...
  return (
    <Container className={css.credentials}>
      <StepDetailsHeader connectorTypeLabel={getString('platform.connectors.signalFXLabel')} />
      <Formik
        formName="createSignalFXConnectorForm"
        initialValues={{ ...initialValues }}
        validationSchema={Yup.object().shape({
          url: Yup.string().trim().required(getString('platform.connectors.signalfx.urlValidation')),
