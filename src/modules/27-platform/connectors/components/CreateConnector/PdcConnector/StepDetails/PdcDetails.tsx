      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          hosts: Yup.string().when('selectionType', {
            ...
            then: Yup.string().required(getString('platform.connectors.pdc.validateHosts'))
          }),
          hostsJson: Yup.array().when('selectionType', {
            ...
            then: Yup.array()
              ...
              .required(getString('platform.connectors.pdc.validateHostsJson'))
          })
        })}
          ...
          <>
            <Container className={css.selectionWrapper}>
              <Text margin={{ top: 'medium', bottom: 'medium' }}>
                {getString('platform.connectors.pdc.selectLabel')}
              </Text>
              <Layout.Horizontal spacing="xxlarge">
                <Radio
                  label={getString('platform.connectors.pdc.manuallyHosts')}
                  inline={true}
                ...
                />
                <Radio
                  label={getString('platform.connectors.pdc.uploadJson')}
                  inline={true}
                  ...
                  <FormInput.TextArea
                    ...
                    label={
                      <HarnessDocTooltip
                        ...
                        labelText={getString('platform.connectors.pdc.hosts')}
                      />
                    }
                  />
                </div>
