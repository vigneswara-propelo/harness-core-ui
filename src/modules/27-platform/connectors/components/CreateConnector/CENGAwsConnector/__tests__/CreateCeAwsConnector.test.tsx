...
describe('Create Secret Manager Wizard', () => {
  test('should render form', async () => {
    ...
    //Cost and Usage Step
    expect(getAllByText(container, 'platform.connectors.ceAws.cur.heading')[0]).toBeDefined()
    ...
    expect(getAllByText(container, 'platform.connectors.ceAws.crossAccountRoleStep1.heading')[0]).toBeDefined()

    fireEvent.mouseOver(getByText(container, 'platform.connectors.costVisibility'))
    expect(getByText(container, 'platform.connectors.ceAws.crossAccountRoleStep1.default.feat1')).toBeDefined()
    ...
    expect(getAllByText(container, 'platform.connectors.ceAws.crossAccountRoleStep2.heading')[0]).toBeDefined()
    ...
    expect(getByText(container, 'platform.connectors.ceAws.testConnection.heading')).toBeDefined()
