    ...
    <div>
      <Layout.Vertical>
        <Text color={Color.GREY_800} font={{ variation: FontVariation.BODY }}>
          {getString('platform.connectors.ceAws.curExising.subHeading', {
        ...
        <div className={css.existingCurTable}>
          <ExpandingSearchInput
            ...
            placeholder={getString('platform.connectors.ceAws.curExising.searchCUR')}
          />
          <Table
            data={curReports}
            columns={[
              {
                ...
                Header: getString('platform.connectors.ceAws.curExising.accountID'),
                id: 'awsAccountId',
                width: '26%'
              },
              {
                accessor: 'reportName',
                Header: getString('platform.connectors.ceAws.cur.reportName'),
                width: '37%'
              },
              {
                accessor: 's3BucketName',
                Header: getString('platform.connectors.ceAws.cur.bucketName'),
                width: '37%'
              }
            ]}
