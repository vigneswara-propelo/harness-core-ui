...
import { CCM_CONNECTOR_SAVE_EVENT, CE_AWS_CONNECTOR_CREATION_EVENTS } from '@platform/connectors/trackingConstants'
...
const TestConnection: React.FC<TestConnectionProps> = props => {
  ...
  const steps: string[] = [
    getString('platform.connectors.ceAws.testConnection.step1'),
    getString('platform.connectors.ceAws.testConnection.step2'),
    getString('platform.connectors.ceAws.testConnection.step3')
  ]
  ...
  return (
    <Layout.Vertical className={css.stepContainer}>
      ...
      <Heading level={2} className={css.header}>
        {getString('platform.connectors.ceAws.testConnection.heading')}
      </Heading>
