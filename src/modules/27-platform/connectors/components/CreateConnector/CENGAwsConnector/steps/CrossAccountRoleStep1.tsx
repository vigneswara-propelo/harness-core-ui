    ...
    const cards = [
      {
        ...
        features: [
          getString('platform.connectors.ceAws.crossAccountRoleStep1.default.feat1'),
        ...
        footer: (
          <>
            ...
            {getString('platform.connectors.ceAws.crossAccountRoleStep1.cards.costVisibility.footer2')}{' '}
            <Text inline font={{ variation: FontVariation.SMALL_BOLD }} color={Color.GREY_600}>
  ...
  return (
    <Layout.Vertical className={css.stepContainer}>
      <Text
        ...
        margin={{ bottom: 'large' }}
      >
        {getString('platform.connectors.ceAws.crossAccountRoleStep1.heading')}
      </Text>
      <Text color={Color.GREY_800} font={{ variation: FontVariation.BODY2 }}>
        {getString('platform.connectors.ceAws.crossAccountRoleStep1.description')}
      </Text>
      <Text color={Color.GREY_800} font={{ variation: FontVariation.BODY2 }} padding={{ top: 'small' }}>
        {getString('platform.connectors.ceAws.crossAccountRoleStep1.info')}
      </Text>
      <Container>
          ...
          <Layout.Horizontal spacing="small" className={css.exitingReportWarning}>
            ...
            <Container>
              <Text font={{ variation: FontVariation.SMALL_SEMI, italic: true }} inline>
                {getString('platform.connectors.costVisibility')}
              </Text>{' '}
              <Text font={{ variation: FontVariation.SMALL_BOLD }} inline>
                {getString('platform.connectors.ceAws.crossAccountRoleStep1.existingCurWarning1', {
              ...
              <Text font={{ variation: FontVariation.SMALL_BOLD }} inline>
                {getString('platform.connectors.ceAws.crossAccountRoleStep1.existingCurWarning2')}
              </Text>
            </Container>
          </Layout.Horizontal>
        ) : null}
    ...
    <>
      ...
      <Container>
        <Text font={{ variation: FontVariation.SMALL_BOLD }} margin={{ bottom: 'xsmall' }}>
          {getString('platform.connectors.ceAws.crossAccountRoleStep1.cards.permissionsInvolved')}
        </Text>
      ...
      <Container>
        <Text font={{ variation: FontVariation.SMALL_BOLD }} margin={{ bottom: 'xsmall' }}>
          {getString('platform.connectors.ceAws.crossAccountRoleStep1.cards.providedBy')}
        </Text>
