...
describe('Create Sumo Logic connector Wizard', () => {
  ...
  test('Ensure validation works', async () => {
    ...
    await waitFor(() => expect(getByText('platform.connectors.sumologic.urlLabel')).not.toBeNull())
    // click submit and verify validation string is visible
    fireEvent.click(container.querySelector('button[type="submit"]')!)
    // check error is visible for secrets
    await waitFor(() => expect(getByText('platform.connectors.sumologic.encryptedAccessIdValidation')).not.toBeNull())
    await waitFor(() => expect(getByText('platform.connectors.sumologic.encryptedAccessKeyValidation')).not.toBeNull())
