...
import { setupGcpKmsFormData } from '@platform/connectors/pages/connectors/utils/ConnectorUtils'
    ...
    <Container padding={{ top: 'medium' }}>
      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          keyRing: Yup.string().trim().required(getString('platform.connectors.gcpKms.keyRingRequired')),
          keyName: Yup.string().trim().required(getString('platform.connectors.gcpKms.keyNameRequired')),
          credentials: Yup.object().required(getString('platform.connectors.gcpKms.credentialsFileRequired'))
        })}
        onSubmit={formData => {
      ...
      >
        <FormikForm>
          <Container margin={{ top: 'medium', bottom: 'xxlarge' }} className={css.container}>
            ...
            <FormInput.Text name="keyRing" label={getString('platform.connectors.gcpKms.keyRing')} />
            <FormInput.Text name="keyName" label={getString('platform.connectors.gcpKms.keyName')} />
            <SecretInput
              name="credentials"
              label={getString('platform.connectors.gcpKms.credentialsFile')}
              type="SecretFile"
