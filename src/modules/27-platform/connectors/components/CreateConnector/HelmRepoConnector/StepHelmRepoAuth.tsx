...
import { setupHelmFormData, useGetHelpPanel } from '@platform/connectors/pages/connectors/utils/ConnectorUtils'
      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          helmRepoUrl: isOCIHelm
            ? Yup.string()
                .matches(OCI_CONNECTOR_URL_REGEX, getString('platform.connectors.httpHelm.helmRepoURLValidation'))
          ...
          <>
            ...
            <Layout.Vertical padding={{ top: 'large', bottom: 'large' }} className={css.secondStep} width={'56%'}>
              <FormInput.Text
                ...
                label={getString('platform.connectors.helmRepo.helmRepoUrl')}
                tooltipProps={{
