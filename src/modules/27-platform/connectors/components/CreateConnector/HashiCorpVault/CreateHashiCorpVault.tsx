...
import { buildVaultPayload } from '@platform/connectors/pages/connectors/utils/ConnectorUtils'
...
const CreateHashiCorpVault: React.FC<CreateConnectorModalProps> = props => {
  ...
  return (
    ...
    >
      ...
      />
      <VaultConfigForm
        name={getString('platform.connectors.hashiCorpVault.stepTwoName')}
      ...
      />
      <SetupEngine
        name={getString('platform.connectors.hashiCorpVault.setupEngine')}
