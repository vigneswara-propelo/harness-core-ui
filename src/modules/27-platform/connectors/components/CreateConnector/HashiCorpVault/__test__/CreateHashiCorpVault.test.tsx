...
describe('Create Secret Manager Wizard', () => {
  test('should render form', async () => {
    ...
    // Step 4
    expect(getAllByText('platform.connectors.hashiCorpVault.setupEngine')[1]).toBeTruthy()
    fillAtForm([
      {
        container,
    ...
    expect(getAllByText('platform.connectors.createdSuccessfully')[0]).toBeTruthy()
  }),
    test('should render form in edit', async () => {
      ...
      // Edit Step 4
      await waitFor(() => expect(getAllByText('platform.connectors.hashiCorpVault.setupEngine')[1]).toBeTruthy())
      fillAtForm([
        {
          container,
          type: InputTypes.TEXTFIELD,
      ...
      await waitFor(() => expect(getAllByText('platform.connectors.updatedSuccessfully')[0]).toBeTruthy())
    })
})
