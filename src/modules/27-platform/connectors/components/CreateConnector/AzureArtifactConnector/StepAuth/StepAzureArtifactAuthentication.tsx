...
import { setupAzureArtifactsFormData } from '@platform/connectors/pages/connectors/utils/ConnectorUtils'
      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          azureArtifactsUrl: Yup.string()
            .trim()
            .required(getString('platform.connectors.azureArtifacts.azureArtifactsUrlRequired')),
          authType: Yup.string().trim().required(getString('validation.authType')),
          tokenRef: Yup.object().required(getString('platform.connectors.azureArtifacts.tokenRefRequired'))
        })}
          ...
          <>
            <Layout.Vertical padding={{ top: 'large', bottom: 'large' }} className={css.secondStep} width={'64%'}>
              <FormInput.Text
                ...
                label={getString('platform.connectors.azureArtifacts.azureArtifactsUrl')}
              />
