...
import { buildELKPayload } from '@platform/connectors/pages/connectors/utils/ConnectorUtils'
...
function ElkConfigStep(props: ConnectionConfigProps): JSX.Element {
  ...
  return (
    <>
      <StepDetailsHeader connectorTypeLabel={getString('platform.connectors.elk.elkLabel')} />
      <Formik
        enableReinitialize
        initialValues={{
          ...initialValues
