...
import { setupDockerFormData, DockerProviderType } from '@platform/connectors/pages/connectors/utils/ConnectorUtils'
...
const StepDockerAuthentication: React.FC<StepProps<StepDockerAuthenticationProps> & DockerAuthenticationProps> =
  props => {
    ...
    const dockerProviderTypeOptions: IOptionProps[] = [
      {
        label: getString('platform.connectors.docker.dockerHub'),
        value: DockerProviderType.DOCKERHUB
      },
      {
        label: getString('platform.connectors.docker.harbor'),
        value: DockerProviderType.HARBOR
      },
      {
        label: getString('platform.connectors.docker.quay'),
        value: DockerProviderType.QUAY
      },
      {
        label: getString('platform.connectors.docker.other'),
            ...
            <>
              ...
              >
                ...
                <FormInput.Text
                  ...
                  label={getString('platform.connectors.docker.dockerRegistryURL')}
                />
