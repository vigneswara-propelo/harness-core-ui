...
import { getHeadingIdByType } from '@platform/connectors/pages/connectors/utils/ConnectorHelper'
...
const OverviewStep: React.FC<StepProps<ConnectorConfigDTO> & OverviewStepProps> = props => {
  ...
  return (
    <Layout.Vertical spacing="xxlarge" className={cx(css.firstep, overviewCss.overviewStep)}>
      ...
      <div className={overviewCss.infoSection}>{getString('platform.connectors.ceK8.infoText')}</div>
                ...
                <Container style={{ minHeight: 300 }}>
                  <Layout.Horizontal flex={{ justifyContent: 'start' }}>
                    <FormInput.Select
                      ...
                      label={getString('platform.connectors.ceK8.selectConnectorLabel')}
                    ...
                    >
                      <Button
                        ...
                        text={getString('platform.connectors.ceK8.overview.createNewConnectorCta')}
                        icon={'plus'}
                      />
                    </Link>
                  </Layout.Horizontal>
                  <NameIdDescriptionTags
                    ...
                    identifierProps={{
                      ...
                      inputLabel: getString('platform.connectors.ceK8.overview.ccmConnectorNameLabel')
                    }}
                  />
                </Container>
                <Layout.Horizontal>
