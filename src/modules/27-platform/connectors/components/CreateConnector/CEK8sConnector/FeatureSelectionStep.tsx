  ...
  const cardData: CardData[] = [
    {
      ...
      text: getString('platform.connectors.ceK8.chooseRequirements.visibility.description'),
      value: 'VISIBILITY',
      heading: getString('platform.connectors.ceK8.chooseRequirements.visibility.heading'),
      subheading: getString('platform.connectors.ceK8.chooseRequirements.visibility.subheading')
    },
    {
      icon: 'gear',
      text: getString('platform.connectors.ceK8.chooseRequirements.optimization.description'),
      value: 'OPTIMIZATION',
      heading: getString('platform.connectors.ceK8.chooseRequirements.optimization.heading'),
      subheading: getString('platform.connectors.ceK8.chooseRequirements.optimization.subheading')
    }
  ]
  ...
  return (
    <Layout.Vertical className={css.featureSelectionCont}>
      <Heading level={2} className={css.header}>
        {getString('platform.connectors.ceK8.chooseRequirements.heading')}
      </Heading>
      <div style={{ padding: 5, paddingBottom: 20 }}>
        {!prevStepData?.spec?.fixFeatureSelection && (
          <Text> {getString('platform.connectors.ceK8.chooseRequirements.subheading')}</Text>
        )}
        {getString(
          prevStepData?.spec?.fixFeatureSelection
            ? 'platform.connectors.ceK8.chooseRequirements.fixFeaturesDescription'
            : 'platform.connectors.ceK8.chooseRequirements.description'
        )}
      </div>
      <div style={{ flex: 1 }}>
        <CardSelect
