...
import { buildAzureKeyVaultPayload } from '@platform/connectors/pages/connectors/utils/ConnectorUtils'
...
const CreateAzureKeyVaultConnector: React.FC<CreateConnectorModalProps> = props => {
  ...
  return (
    ...
    >
      ...
      />
      <SetupVault
        name={getString('platform.connectors.azureKeyVault.labels.setupVault')}
