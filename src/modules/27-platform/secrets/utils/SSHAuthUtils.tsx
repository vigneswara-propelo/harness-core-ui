...
export const getStringForType = (type?: SecretDTOV2['type']): React.ReactElement => {
  if (!type) return <String stringID="platform.secrets.blank" />
  switch (type) {
    case 'SecretText':
      return <String stringID="platform.secrets.secret.labelText" />
    case 'SecretFile':
      return <String stringID="platform.secrets.secret.labelFile" />
    case 'SSHKey':
      return <String stringID="platform.secrets.typeSSH" />
    case 'WinRmCredentials':
      return <String stringID="platform.secrets.typeWinRM" />
    default:
      return <String stringID="platform.secrets.blank" />
  }
}
...
export const getKeyForCredentialType = (type?: SSHConfigDTO['credentialType']): React.ReactElement => {
  switch (type) {
    case 'Password':
      return <String stringID="platform.secrets.sshAuthFormFields.optionPassword" />
    case 'KeyPath':
      return <String stringID="platform.secrets.sshAuthFormFields.optionKeypath" />
    case 'KeyReference':
      return <String stringID="platform.secrets.sshAuthFormFields.optionKey" />
    default:
      return <String stringID="platform.secrets.blank" />
  }
}
