        ...
        <Text font={{ size: 'medium' }} color={Color.BLACK} margin={{ bottom: 'large' }}>
          {secret?.identifier
            ? !type || type === 'SecretText'
              ? getString('platform.secrets.secret.titleEditText')
              : getString('platform.secrets.secret.titleEditFile')
            : type === 'SecretText'
            ? getString('platform.secrets.secret.titleCreateText')
            : getString('platform.secrets.secret.titleCreateFile')}
        </Text>
        <CreateUpdateSecret
          secret={secret}
          type={type}
