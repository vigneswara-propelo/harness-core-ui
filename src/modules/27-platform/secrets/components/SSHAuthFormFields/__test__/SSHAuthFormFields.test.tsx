...
describe('Create SSH Cred Wizard', () => {
  ...
  test('Kerberos , radio btns', async () => {
    ...
    const RadioKerbNone = getByLabelText('platform.secrets.sshAuthFormFields.optionKerbNone')
    expect(RadioKerbNone).toBeInTheDocument()
    const RadioLabelKey = getByLabelText('platform.secrets.sshAuthFormFields.labelKeyTab')
