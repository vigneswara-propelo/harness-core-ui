...
describe('Secrets Page', () => {
  ...
  test('create secret', async () => {
    ...
    const createTextSecretButton = await findAllByText('platform.secrets.secret.labelText')
    act(() => {
...
describe('Secrets List', () => {
  ...
  test('Delete SSH', async () => {
    ...
    await act(async () => {
      ...
      await waitFor(() => queryAllByText(document.body, 'platform.secrets.confirmDeleteTitle'))
      const form = findDialogContainer()
      expect(form).toBeTruthy()
  ...
  test('Verify Connection SSH', async () => {
    ...
    await act(async () => {
      ...
      await waitFor(() => queryAllByText(document.body, 'platform.secrets.createSSHCredWizard.btnVerifyConnection'))
    })
