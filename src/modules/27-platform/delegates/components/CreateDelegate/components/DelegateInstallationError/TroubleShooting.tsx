...
import { Container, Layout, Text, Button } from '@harness/uicore'
...
const TroubleShooting: React.FC<TroubleShootingProps> = props => {
  ...
  const docsLink = (
    <div style={{ padding: 'var(--spacing-medium) 0px' }}>
      <a href="https://docs.harness.io" target="_blank" rel="noreferrer" style={{ marginTop: 'var(--spacing-medium)' }}>
        {getString('platform.delegates.harnessDocs')}
      </a>
    </div>
  )
  ...
  const harnessSupportEmail = (
    <div className={css.harnessSupportContainer}>
      <a href="mailto:support@harness.io">{getString('platform.delegates.delegateNotInstalled.contactHarness')}</a>
    </div>
  )
  ...
  return (
    <Layout.Vertical width={630} style={{ padding: '0px var(--spacing-large)' }}>
      ...
      >
        ...
        >
          {getString('platform.delegates.delegateNotInstalled.tabs.commonProblems.hereIsWhatYouCanDo')}
        </Text>
        <Button
          intent="primary"
          minimal
      ...
      <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
        <Layout.Horizontal flex>
          <Text color={Color.BLACK_100}>{getString('platform.delegates.delegateNotInstalled.statusOfCluster')}</Text>
          <a
        ...
        >
          <Text>
            {delegateType === DelegateTypes.DOCKER
              ? getString('platform.delegates.delegateNotInstalled.verifyStatus2')
              : getString('platform.delegates.delegateNotInstalled.podCommand')}
          </Text>
          <CopyToClipboard
            content={
              delegateType === DelegateTypes.DOCKER
      ...
      {activeEvent === TroubleShootingTypes.VERIFY_CONTAINER_STATUS && (
        <Container className={css.podCmndVerification} style={{ padding: 'var(--spacing-medium) 0px' }}>
          <Text color={Color.BLACK_100}>{getString('platform.delegates.delegateNotInstalled.containerRunning')}</Text>
      ...
      {activeEvent === TroubleShootingTypes.VERIFY_PODS_COMEUP && (
        <Container className={css.podCmndVerification} style={{ padding: 'var(--spacing-medium) 0px' }}>
          <Text color={Color.BLACK_100}>{getString('platform.delegates.delegateNotInstalled.podComeUp')}</Text>
          <Container style={{ marginTop: 'var(--spacing-medium)' }}>
            <Button
              onClick={() => {
                setActiveEvent(TroubleShootingTypes.VERIFY_HARNESS_SASS)
        ...
        <>
          <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
            <Text color={Color.BLACK_100}>
              {getString('platform.delegates.delegateNotInstalled.harnessErrorValidation')}
            </Text>
          </Layout.Vertical>
      ...
      {activeEvent === TroubleShootingTypes.CURL_HARNESS_IO && (
        <>
          <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
            <CommonText>{getString('platform.delegates.delegateNotInstalled.curlHarnessIO')}</CommonText>
            <CommonText>{getString('platform.delegates.delegateNotInstalled.curlHarnessIO2')}</CommonText>
            <CommonText>{getString('platform.delegates.delegateNotInstalled.curlHarnessIO3')}</CommonText>
          </Layout.Vertical>
          <Container className={css.podCmndVerification}>
            <Button
              onClick={() => {
      ...
      {activeEvent === TroubleShootingTypes.DO_YOU_HAVE_PROXY && (
        <>
          <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
            <Text color={Color.BLACK_100}>{getString('platform.delegates.delegateNotInstalled.doYouHaveProxy')}</Text>
          </Layout.Vertical>
          <Container className={css.podCmndVerification}>
            <Button
              onClick={() => {
      ...
      {activeEvent === TroubleShootingTypes.CHECK_PROXY && (
        <>
          <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
            <CommonText>{getString('platform.delegates.delegateNotInstalled.checkProxy')}</CommonText>
          </Layout.Vertical>
          <Container className={css.podCmndVerification}>
            <Button
              onClick={() => {
      ...
      {activeEvent === TroubleShootingTypes.CONTAINER_RUNNING && (
        <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
          <Layout.Horizontal flex>
            <Text color={Color.BLACK_100}>
              {getString('platform.delegates.delegateNotInstalled.tabs.commonProblems.checkTheDelegateLogs')}
            </Text>
            <a
              href="https://docs.harness.io/"
              target="_blank"
          ...
          <Container
            ...
            className={css.podCmndField}
          >
            <Text>{getString('platform.delegates.delegateNotInstalled.verifyLogs1')}</Text>
            <CopyToClipboard content={getString('platform.delegates.delegateNotInstalled.verifyLogs1')} />
          </Container>
          <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
            <CommonText>{getString('platform.delegates.delegateNotInstalled.logsError')}</CommonText>
            {harnessSupportEmail}
            {docsLink}
          </Layout.Vertical>
        </Layout.Vertical>
      ...
      {activeEvent === TroubleShootingTypes.VERIFY_EVENTS && (
        <>
          <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
            <Text color={Color.BLACK_100}>{getString('platform.delegates.delegateNotInstalled.eventErrorBlock')}</Text>
          </Layout.Vertical>
          <Container className={css.btnContainer}>
            <Button
              ...
              className={css.error}
            >
              {getString('platform.delegates.delegateNotInstalled.permissionError')}
            </Button>
            <Button
            ...
            >
              {getString('platform.delegates.delegateNotInstalled.crashloopError')}
            </Button>
            <Button
              ...
              className={`${css.error} ${css.addSpacing}`}
            >
              {getString('platform.delegates.delegateNotInstalled.pullError')}
            </Button>
          </Container>
        </>
      )}
      {activeEvent === TroubleShootingTypes.CHECK_CLUSTER_PERMISSION && (
        <>
          <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
            <CommonText>{getString('platform.delegates.delegateNotInstalled.checkClusterPermission')}</CommonText>
            <CommonText>{getString('platform.delegates.delegateNotInstalled.checkClusterPermission2')}</CommonText>
            {harnessSupportEmail}
            {docsLink}
          </Layout.Vertical>
        </>
      ...
      {activeEvent === TroubleShootingTypes.CONTAINER_FAILED_START && (
        <>
          <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
            <CommonText>{getString('platform.delegates.delegateNotInstalled.eventErrorBlock')}</CommonText>
          </Layout.Vertical>
          <Container className={css.btnContainer}>
            <Button
              ...
              className={css.error}
            >
              {getString('platform.delegates.delegateNotInstalled.applicationError')}
            </Button>
            <Button
              ...
              className={`${css.error} ${css.addSpacing}`}
            >
              {getString('platform.delegates.delegateNotInstalled.CPUorMemError')}
            </Button>
          </Container>
        </>
      )}
      {activeEvent === TroubleShootingTypes.CHECK_CLUSTER_CONFIG && (
        <>
          <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
            <CommonText>{getString('platform.delegates.delegateNotInstalled.checkClusterConfig')}</CommonText>
            <CommonText>{getString('platform.delegates.delegateNotInstalled.checkClusterConfig2')}</CommonText>
          </Layout.Vertical>
          <Container className={css.podCmndVerification}>
            <Button
              onClick={() => {
      ...
      {activeEvent === TroubleShootingTypes.CAN_CLUSTER_CONNECT_TO_REGISTRY && (
        <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
          <CommonText>
            {getString('platform.delegates.delegateNotInstalled.checkCanClusterConnectToRegistry')}
          </CommonText>
          <CommonText>{getString('platform.delegates.delegateNotInstalled.contactHarness')}</CommonText>
          {docsLink}
        </Layout.Vertical>
      )}
      {/* end messages */}
      {activeEvent === TroubleShootingTypes.CHECK_FIREWALL_PORTS && (
        <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
          <CommonText>{getString('platform.delegates.delegateNotInstalled.checkFirewallPorts')}</CommonText>
          {harnessSupportEmail}
          {docsLink}
        </Layout.Vertical>
      )}
      {activeEvent === TroubleShootingTypes.GOOD_TO_GO && (
        <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
          <CommonText>{getString('platform.delegates.delegateNotInstalled.goodToGo')}</CommonText>
        </Layout.Vertical>
      )}
      ...
      {activeEvent === TroubleShootingTypes.CONTAINER_NOT_RUNNING && (
        <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
          ...
          <Layout.Vertical width={511} style={{ padding: 'var(--spacing-medium) 0px' }}>
            <CommonText>{getString('platform.delegates.delegateNotInstalled.checkError')}</CommonText>
            <Container
              intent="primary"
              padding="small"
              font={{
            ...
            >
              <Text style={{ marginRight: '24px' }}>
                {getString('platform.delegates.delegateNotInstalled.heartbeatFailed')}
              </Text>
            </Container>
            <CommonText>{getString('platform.delegates.delegateNotInstalled.logsError')}</CommonText>
            {harnessSupportEmail}
