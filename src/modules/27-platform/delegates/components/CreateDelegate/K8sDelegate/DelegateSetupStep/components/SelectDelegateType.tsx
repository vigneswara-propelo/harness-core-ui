  ...
  return (
    <Container padding={{ top: 'medium', bottom: 'medium' }}>
      <Layout.Vertical spacing="medium">
        <Text>{getString('platform.delegates.delegateCreation.installerText')}</Text>
        <CardSelect
      ...
      {formikProps?.touched.delegateType && !formikProps?.values.delegateType ? (
        <Container padding={{ top: 'xsmall' }}>
          <FormError
            name={'delegateType'}
            errorMessage={getString('platform.delegates.delegateCreation.installerSelectionRequired')}
          />
        </Container>
      ) : null}
    </Container>
