                  ...
                  <Layout.Horizontal className={css.baseContainer}>
                    <Layout.Vertical className={css.leftPanel}>
                      ...
                      <Layout.Horizontal className={css.tokensSelectContainer} spacing="small">
                        <FormInput.Select
                          ...
                          label={getString('platform.delegates.tokens.delegateTokens')}
                          name="tokenName"
                        />
                        <Button
                          minimal
                      ...
                      <Layout.Horizontal className={css.runAsRootCheckbox}>
                        <FormInput.CheckBox
                          name="runAsRoot"
                          label={getString('platform.delegates.runAsRoot')}
                    ...
                    <Layout.Vertical className={css.rightPanel}>
                      <div className={css.permissionsTitle} data-tooltip-id="delegatePermissions">
                        {getString('platform.delegates.delegatePermissions.title')}
                      ...
                      <CardSelect
                        ...
                        renderItem={item => {
                          ...
                          if (item === k8sPermissionType.CLUSTER_ADMIN) {
                            title = getString('platform.delegates.delegatePermissions.clusterWriteTitle')
                            subtitle = getString('platform.delegates.delegatePermissions.clusterWriteContent')
                          } else if (item === k8sPermissionType.CLUSTER_VIEWER) {
                            title = getString('platform.delegates.delegatePermissions.clusterReadTitle')
                            subtitle = getString('platform.delegates.delegatePermissions.clusterReadContent')
                          } else if (item === k8sPermissionType.NAMESPACE_ADMIN) {
                            title = getString('platform.delegates.delegatePermissions.specificNamespaceTitle')
                            subtitle = getString('platform.delegates.delegatePermissions.specificNamespaceContent')
                          }
                          return (
                            <Container>
