      ...
      <Layout.Vertical className={css.panelLeft}>
        ...
        <Layout.Horizontal className={css.descriptionVerificationWrapper}>
          <Text font="normal" width={408}>
            {getString('platform.delegates.successVerification.applyYAMLTitleForHelm')}
          </Text>
        </Layout.Horizontal>
        <Layout.Horizontal>
          <Text font="normal" width={408}>
            {getString('platform.delegates.successVerification.addHelmRepoLabel')}
          </Text>
        </Layout.Horizontal>
        <Layout.Horizontal width={530} spacing="small" className={css.verificationFieldWrapper}>
          ...
          >
            <Text style={{ marginRight: 'var(--spacing-xlarge)' }} font="small">
              {getString('platform.delegates.successVerification.addHelmRepoCmd')}
            </Text>
            <CopyToClipboard content={getString('platform.delegates.successVerification.addHelmRepoCmd').slice(2)} />
          </Container>
        </Layout.Horizontal>
        <Layout.Horizontal>
          <Text font="normal" width={408}>
            {getString('platform.delegates.successVerification.updateHelmRepoLabel')}
          </Text>
        </Layout.Horizontal>
        <Layout.Horizontal width={530} spacing="small" className={css.verificationFieldWrapper}>
          <Container
          ...
          >
            <Text style={{ marginRight: 'var(--spacing-xlarge)' }} font="small">
              {getString('platform.delegates.successVerification.helmRepoUpdate')}
            </Text>
            <CopyToClipboard content={getString('platform.delegates.successVerification.helmRepoUpdate')} />
          </Container>
        </Layout.Horizontal>
        <Layout.Horizontal>
          <Text font="normal" width={408}>
            {getString('platform.delegates.successVerification.installHelmChartLabel')}
          </Text>
        </Layout.Horizontal>
        <Layout.Horizontal width={530} spacing="small" className={css.verificationFieldWrapper}>
          <Container
          ...
          >
            <Text style={{ marginRight: 'var(--spacing-xlarge)' }} font="small">
              {insert(getString('platform.delegates.successVerification.installHelmChartCmd'), 15, prevStepData?.name)}
            </Text>
            <CopyToClipboard
              content={insert(
                getString('platform.delegates.successVerification.installHelmChartCmd'),
                15,
                prevStepData?.name
              ).slice(2)}
            />
