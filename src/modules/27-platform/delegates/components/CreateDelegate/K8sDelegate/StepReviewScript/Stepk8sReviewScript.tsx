        ...
        <Layout.Vertical spacing="medium">
          ...
          <Layout.Vertical padding="small">
            <Text lineClamp={3} width={514} font="small">
              {isDelegateTypeHelm
                ? getString('platform.delegates.reviewScript.descriptionHelmProxySettings')
                : getString('delegate.reviewScript.descriptionProxySettings')}
            </Text>
            <Text lineClamp={3} width={514} font="small">
              {getString('platform.delegates.reviewScript.docLinkBefore')}
              <a
                rel="noreferrer"
                href={
                  isDelegateTypeHelm
                ...
                target="_blank"
              >
                {getString('platform.delegates.reviewScript.docLink')}
              </a>
              {getString('platform.delegates.reviewScript.docLinkAfter')}
            </Text>
          </Layout.Vertical>
        </Layout.Vertical>
      </Layout.Horizontal>
