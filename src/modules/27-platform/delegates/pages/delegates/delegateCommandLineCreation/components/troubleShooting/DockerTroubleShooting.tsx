    ...
    <Layout.Vertical spacing="none">
      ...
      <Container margin={{ bottom: 'xxlarge' }}>
        <CommandBlock
          ...
          commandSnippet={getString('platform.delegates.delegateNotInstalled.verifyStatus1')}
          allowCopy={true}
        />
      </Container>
      <Text margin={{ bottom: 'medium' }} font={{ variation: FontVariation.H6 }}>
        {getString('platform.delegates.commandLineCreation.helmTroubleShooting6')}
      </Text>
      <Container margin={{ bottom: 'xxlarge' }}>
        <CommandBlock
          telemetryProps={{
          ...
          commandSnippet={getString('platform.delegates.commandLineCreation.dockerTroubleShooting1')}
          allowCopy={true}
        />
      </Container>
      <Text margin={{ bottom: 'medium' }} font={{ variation: FontVariation.H6 }}>
        {getString('platform.delegates.commandLineCreation.dockerTroubleShooting2')}
      </Text>
      <Container margin={{ bottom: 'medium' }}>
        <CommandBlock
          ...
          commandSnippet={getString('platform.delegates.commandLineCreation.dockerTroubleShooting3')}
          allowCopy={true}
        />
      </Container>
      <Container margin={{ bottom: 'xxlarge' }}>
        <CommandBlock
          ...
          commandSnippet={getString('platform.delegates.commandLineCreation.dockerTroubleShooting4')}
          allowCopy={true}
        />
      </Container>
      <Text margin={{ bottom: 'medium' }} font={{ variation: FontVariation.H6 }}>
        {getString('platform.delegates.commandLineCreation.dockerTroubleShooting5')}
      </Text>
      <Container margin={{ bottom: 'xxlarge' }}>
        <CommandBlock
          telemetryProps={{
          ...
          commandSnippet={getString('platform.delegates.commandLineCreation.dockerTroubleShooting6')}
          allowCopy={true}
        />
      </Container>
    </Layout.Vertical>
