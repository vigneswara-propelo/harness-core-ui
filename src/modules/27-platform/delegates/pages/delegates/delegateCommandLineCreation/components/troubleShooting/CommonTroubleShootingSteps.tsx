    ...
    <Layout.Vertical>
      ...
      <Container margin={{ bottom: 'xxlarge' }}>
        <CommandBlock
          ...
          commandSnippet={getString('platform.delegates.delegateNotInstalled.podCommand')}
          allowCopy={true}
        />
      </Container>
      <Text margin={{ bottom: 'medium' }} font={{ variation: FontVariation.H6 }}>
      ...
      <Container margin={{ bottom: 'xxlarge' }}>
        <CommandBlock
          ...
          commandSnippet={getString('platform.delegates.delegateNotInstalled.verifyField2')}
          allowCopy={true}
        />
      </Container>
      <Text margin={{ bottom: 'medium' }} font={{ variation: FontVariation.BODY }}>
        {getString('platform.delegates.commandLineCreation.helmTroubleShooting7')}
      </Text>
      <Text margin={{ bottom: 'medium' }} font={{ variation: FontVariation.H6 }}>
      ...
      <Container margin={{ bottom: 'xxlarge' }}>
        <CommandBlock
          ...
          commandSnippet={getString('platform.delegates.delegateNotInstalled.verifyField3')}
          allowCopy={true}
        />
      </Container>
    </Layout.Vertical>
