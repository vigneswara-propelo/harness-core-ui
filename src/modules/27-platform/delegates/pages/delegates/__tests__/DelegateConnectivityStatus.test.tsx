...
describe('Delegate connectivity status component', () => {
  test('Open troubleshoot', async () => {
    ...
    const troubleShoot = queryByText('platform.delegates.troubleshootOption')
    ...
    await waitFor(() =>
      expect(queryByText('platform.delegates.delegateNotInstalled.tabs.commonProblems.title')).not.toBeInTheDocument()
    )
  })
})
