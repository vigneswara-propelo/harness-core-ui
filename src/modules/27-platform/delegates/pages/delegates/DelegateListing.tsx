...
export const DelegateListing: React.FC<DelegatesListProps> = ({ filtersMockData }) => {
  ...
  useDocumentTitle(getString('platform.delegates.delegatesTitle'))
  ...
  fieldToLabelMapping.set('delegateGroupIdentifier', getString('platform.delegates.delegateIdentifier'))
  ...
  const newDelegateBtn = (
    <RbacButton
      ...
      text={
        hideHeader
          ? getString('platform.delegates.commandLineCreation.installDelegate')
            ...
            {delegateGroups.length ? (
              ...
              <div className={css.emptyStateContainer}>
                ...
                <div className={css.emptyStateText}>
                  {projectIdentifier
                    ? getString('platform.delegates.noDelegatesInProject')
                    : orgIdentifier
                    ? getString('platform.delegates.noDelegatesInOrganization')
                    : getString('platform.delegates.noDelegatesInAccount')}
                </div>
