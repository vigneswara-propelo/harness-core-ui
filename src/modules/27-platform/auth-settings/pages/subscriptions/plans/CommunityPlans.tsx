...
const linkStringKey: StringKeys = 'platform.authSettings.cdCommunityPlan.planLink'
...
const CommunityPlansCard = (): React.ReactElement => {
  ...
  const communityPlanStrings = [
    getString('platform.authSettings.cdCommunityPlan.communityPlanStrings.item1'),
    getString('platform.authSettings.cdCommunityPlan.communityPlanStrings.item2'),
    getString('platform.authSettings.cdCommunityPlan.communityPlanStrings.item3'),
    getString('platform.authSettings.cdCommunityPlan.communityPlanStrings.item4'),
    getString('platform.authSettings.cdCommunityPlan.communityPlanStrings.item5')
  ]
    ...
    <Card className={cx(css.plan, PlanCss.currentPlan, PlanCss.cdBorder)}>
      <Layout.Vertical flex={{ align: centerCenter }}>
        ...
        >
          ...
          <Text font={{ weight: 'semi-bold', size: 'large' }} className={css.titleFont}>
            {getString('platform.authSettings.cdCommunityPlan.communityTitle')}
          </Text>
          <Layout.Vertical padding={{ top: 'large', bottom: 'xxxlarge' }} flex={{ align: centerCenter }}>
            <Text font={{ weight: 'semi-bold', size: 'medium' }} color={Color.BLACK}>
              {getString('platform.authSettings.cdCommunityPlan.communityPrice')}
            </Text>
          </Layout.Vertical>
          <Text
            color={Color.BLACK}
          ...
          >
            {getString('platform.authSettings.cdCommunityPlan.communityTitle2')}
          </Text>
        </Layout.Vertical>
      </Layout.Vertical>
      ...
      >
        <Text className={css.communityplanSupport}>
          <a href={getString(linkStringKey)}>{getString('platform.authSettings.cdCommunityPlan.communityLinkText')}</a>
        </Text>
      </Layout.Vertical>
    </Card>
  )
...
const EnterprisePlansCard = (): React.ReactElement => {
  ...
  const enterpriseListStrings = [
    getString('platform.authSettings.cdCommunityPlan.enterprisePlanStrings.item1'),
    getString('platform.authSettings.cdCommunityPlan.enterprisePlanStrings.item2'),
    getString('platform.authSettings.cdCommunityPlan.enterprisePlanStrings.item3'),
    getString('platform.authSettings.cdCommunityPlan.enterprisePlanStrings.item4'),
    getString('platform.authSettings.cdCommunityPlan.enterprisePlanStrings.item5')
  ]
  return (
    <Card className={cx(css.plan, css.normalPlanBorder)}>
      <Layout.Vertical flex={{ align: centerCenter }} padding={{ bottom: 'large' }}>
        ...
        >
          ...
          <Text font={{ weight: 'semi-bold', size: 'large' }} className={css.titleFont}>
            {getString('platform.authSettings.cdCommunityPlan.enterpriseTitle')}
          </Text>
          {getVerticalPart(
            getString,
            'platform.authSettings.cdCommunityPlan.enterpriseTitle2',
            linkStringKey,
            'platform.authSettings.cdCommunityPlan.enterpriseLinkText'
          )}
        </Layout.Vertical>
      </Layout.Vertical>
      <div>
  ...
  return (
    <Card className={cx(css.plan, css.normalPlanBorder)}>
      <Layout.Vertical flex={{ align: centerCenter }}>
        {getVerticalPart(
          getString,
          'platform.authSettings.cdCommunityPlan.saasTitle2',
          linkStringKey,
          'platform.authSettings.cdCommunityPlan.saasLinkText',
          saasImage
        )}
      </Layout.Vertical>
    </Card>
    ...
    <Layout.Vertical className={PlansCss.plans} spacing="large">
      ...
      <a target="_blank" href={getString(linkStringKey)} rel="noreferrer">
        <Text
          ...
          flex={{ align: centerCenter }}
        >
          {getString('platform.authSettings.cdCommunityPlan.harnessLinkText')}
        </Text>
      </a>
    </Layout.Vertical>
  )
