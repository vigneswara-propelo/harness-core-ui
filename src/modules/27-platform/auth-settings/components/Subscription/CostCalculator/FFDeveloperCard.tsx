      ...
      case 'cf':
        return (
          <Text font={{ variation: FontVariation.H5 }}>
            {getString('platform.authSettings.costCalculator.developer.title')}
          </Text>
        )
      case 'ci':
        return (
          <Text font={{ variation: FontVariation.H5 }}>
            {getString('platform.authSettings.costCalculator.developer.titleCI')}
          </Text>
        )
    }
  }
    ...
    <Layout.Vertical padding={{ bottom: 'medium' }}>
      ...
      <Layout.Horizontal spacing={'small'}>
        <Text
          ...
          tooltip={getString('platform.authSettings.costCalculator.developer.developerDefinition')}
          font={{ size: 'xsmall' }}
        >
          {getString('platform.authSettings.costCalculator.developer.developer')}
        </Text>
      </Layout.Horizontal>
    </Layout.Vertical>
  )
