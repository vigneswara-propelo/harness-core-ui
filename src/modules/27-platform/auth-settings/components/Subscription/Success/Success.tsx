  ...
  return (
    ...
    >
      ...
      <Layout.Horizontal spacing={'small'}>
        ...
        >
          {getString('platform.authSettings.success.woohoo')}
        </Text>
        <Text font={{ variation: FontVariation.H3, weight: 'bold' }}>
          {getString('platform.authSettings.success.title')}
        </Text>
      </Layout.Horizontal>
      <Text font={{ variation: FontVariation.H5 }}>
        {getString('platform.authSettings.success.msg', {
