...
const CreateIPAllowlistWizard: React.FC<CreateIPAllowlistProps> = props => {
  ...
  return (
    <StepWizard title={getString('platform.authSettings.ipAllowlist')}>
      <StepOverview name={getString('overview')} data={ipAllowlistData} {...commonProps} />
      <StepDefineRange
        name={getString('platform.authSettings.ipAddress.defineRange')}
        data={ipAllowlistData}
        {...commonProps}
      />
      <StepTestIP name={getString('platform.authSettings.ipAddress.testIP')} data={ipAllowlistData} {...commonProps} />
    </StepWizard>
  )
}
