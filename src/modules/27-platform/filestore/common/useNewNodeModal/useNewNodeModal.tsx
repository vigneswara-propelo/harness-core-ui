    ...
    switch (typeNode) {
      case FileStoreNodeTypes.FILE:
        return {
          ...
          title: editMode ? getString('platform.filestore.editFileDetails') : getString('platform.filestore.newFile'),
          icon: FileAddIcon,
          height: 'auto'
        }
      case FileStoreNodeTypes.FOLDER:
        return {
          ...
          label: getString('edit'),
          title: editMode
            ? getString('platform.filestore.editFolderDetails')
            : getString('platform.filestore.newFolder'),
          icon: FolderAddIcon,
          height: 302
        }
    }
