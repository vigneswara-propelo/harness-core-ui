    ...
    try {
      if (!isCachedNode(currentNode?.identifier)) {
        ...
        if (responseUpdate.status === 'SUCCESS') {
          showSuccess(getString('platform.filestore.fileSuccessSaved', { name: currentNode.name }))
          setUnsavedNodes([])
        }
      } else {
        ...
        if (response.status === 'SUCCESS') {
          ...
          setTempNodes([])
          setUnsavedNodes([])
          showSuccess(getString('platform.filestore.fileSuccessCreated', { name: currentNode.name }))
        }
      }
                ...
                >
                  ...
                  >
                    ...
                    <Container padding={{ left: 'small' }} flex={{ justifyContent: 'space-between' }}>
                      <Container flex>
                        <Text>{getString('platform.filestore.view.fileUsage')}:</Text>
