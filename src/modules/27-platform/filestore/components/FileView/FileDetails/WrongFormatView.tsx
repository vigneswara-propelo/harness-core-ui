...
import { Container, Layout, Text, Button, ButtonVariation, Icon } from '@harness/uicore'
      ...
      <Layout.Vertical spacing={'xxlarge'} height={'100%'} flex={{ align: 'center-center' }}>
        ...
        <Container>
          <Text font={{ weight: 'bold', size: 'medium', align: 'center' }} color={Color.GREY_600}>
            {getString('platform.filestore.view.noPreview')}
          </Text>
          <Container margin={{ top: 'medium' }}>
            <Text font={{ size: 'normal' }} color={Color.GREY_600}>
              {getString('platform.filestore.errors.cannotRender')}
            </Text>
          </Container>
        </Container>
        <Button
