...
import GlobalEnvironmentOverrides from './Environment/GlobalOverrides'
import EnvironmentServiceSpecificOverrides from './Environment/ServiceSpecific'
import GlobalInfrastructureOverrides from './Infrastructure/GlobalOverrides'
import InfrastructureServiceSpecificOverrides from './Infrastructure/ServiceSpecific'
...
export default function ServiceOverrides(): React.ReactElement {
  ...
  const [selectedTabId, setSelectedTabId] = useState(ServiceOverridesTab.ENVIRONMENT_GLOBAL)

  const { updateQueryParams } = useUpdateQueryParams<{ sectionId: ServiceOverridesTab }>()
