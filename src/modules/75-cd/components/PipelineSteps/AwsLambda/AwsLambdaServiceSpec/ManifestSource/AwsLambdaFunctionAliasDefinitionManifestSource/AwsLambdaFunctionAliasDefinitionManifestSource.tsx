...
export class AwsLambdaFunctionAliasDefinitionManifestSource extends ManifestSourceBase<ManifestSourceRenderProps> {
  protected manifestType = ManifestDataType.AwsLambdaFunctionAliasDefinition
