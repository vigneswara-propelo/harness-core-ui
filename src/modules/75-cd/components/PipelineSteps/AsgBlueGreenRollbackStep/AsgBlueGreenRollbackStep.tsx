...
interface AsgBlueGreenRollbackStepVariableStepProps {
...
export class AsgBlueGreenRollbackStep extends PipelineStep<StepElementConfig> {
  ...
  renderStep(props: StepProps<StepElementConfig>): JSX.Element {
    ...
    if (this.isTemplatizedView(stepViewType)) {
      ...
      const { variablesData, metadataMap } = customStepProps as AsgBlueGreenRollbackStepVariableStepProps
      return (
        <VariablesListTable
    ...
    return (
      <GenericExecutionStepEditRef
        ...
        ref={formikRef}
        readonly={readonly}
        formikFormName={'AsgBlueGreenRollbackFormikForm'}
      />
    )
  }
