...
import { IconName, RUNTIME_INPUT_VALUE } from '@harness/uicore'
...
export const getTemplateWithManifestFields = (): ServiceSpec => ({
  ...
  // To be updated with proper stage data - v1,v2,artifact template once BE APIs are ready
  artifacts: {
    primary: {
      ...
      spec: {
        ...
        repositoryUrl: RUNTIME_INPUT_VALUE,
        repositoryPort: RUNTIME_INPUT_VALUE,
...
export const tasPipelineContext = {
  state: {
    pipeline: {
      name: 'Pipeline 1',
