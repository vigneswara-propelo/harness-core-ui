...
import { ECSCanaryDeployStep } from '../ECSCanaryDeployStep'

factory.registerStep(new ECSCanaryDeployStep())

const existingInitialValues = { identifier: 'Step_1', name: 'Step 1', timeout: '20m', type: StepType.EcsCanaryDeploy }
const onUpdate = jest.fn()
const onChange = jest.fn()

describe('EcsCanaryDeployStep tests', () => {
  beforeEach(() => {
    onUpdate.mockReset()
    onChange.mockReset()
  })
      ...
      <TestStepWidget
        ...
        customStepProps={{
          ...
          metadataMap: {
            'Step 1': {
              yamlProperties: {
                fqn: 'pipeline.stages.qaStage.execution.steps.EcsCanaryDeploy.name',
                localName: 'step.EcsCanaryDeploy.name'
              }
            },
            '20m': {
              yamlProperties: {
                fqn: 'pipeline.stages.qaStage.execution.steps.EcsCanaryDeploy.timeout',
                localName: 'step.EcsCanaryDeploy.timeout'
              }
            }
          }
        }}
