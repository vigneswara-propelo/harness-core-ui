...
export interface AwsCDKDeployStepProps {
...
const AwsCDKDeployStepEdit = (
  props: AwsCDKDeployStepProps,
  ...
  const getInitialValues = (): AwsCDKCommonStepFormikValues => {
    return {
      ...
      spec: {
        ...
        parameters: Object.keys(defaultTo(initialValues.spec?.parameters, {})).map(paramKey => {
          const paramValue = initialValues.spec?.parameters?.[paramKey]
          return {
            id: uuid('', nameSpace()),
            key: paramKey,
            value: defaultTo(paramValue, '')
          }
        })
      }
    }
          ...
          return (
            <FormikForm>
              ...
              <Accordion className={stepCss.accordion}>
                <Accordion.Panel
                  id="aws-cdk-deploy-optional-accordion"
                  data-testid={'aws-cdk-deploy-optional-accordion'}
                  ...
                  details={
                    <Container margin={{ top: 'medium' }}>
                      <AwsCdkCommonOptionalFieldsEdit
                        ...
                        commandOptionsFieldLabel={getString('cd.steps.awsCdkStep.awsCdkDeployCommandOptions')}
...
export const AwsCDKDeployStepEditRef = React.forwardRef(AwsCDKDeployStepEdit)
