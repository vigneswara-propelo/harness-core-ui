...
function AwsCDKDiffStepInputSet(props: AwsCDKDiffStepInputSetProps): React.ReactElement {
...
export const AwsCDKDiffStepInputSetMode = connect(AwsCDKDiffStepInputSet)
