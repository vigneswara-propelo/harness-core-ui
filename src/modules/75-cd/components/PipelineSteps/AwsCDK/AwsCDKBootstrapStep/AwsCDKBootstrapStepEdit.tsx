...
export interface AwsCDKBootstrapStepProps {
...
const AwsCDKBootstrapStepEdit = (
  props: AwsCDKBootstrapStepProps,
  ...
  return (
    <>
      <Formik<AwsCDKCommonStepFormikValues>
        ...
        formName="AwsCDKBootstrapStepEdit"
          ...
          return (
            <FormikForm>
              ...
              <Accordion className={stepCss.accordion}>
                <Accordion.Panel
                  id="aws-cdk-bootstrap-optional-accordion"
                  data-testid={'aws-cdk-bootstrap-optional-accordion'}
                  ...
                  details={
                    <Container margin={{ top: 'medium' }}>
                      <AwsCdkCommonOptionalFieldsEdit
                        ...
                        commandOptionsFieldLabel={getString('cd.steps.awsCdkStep.awsCdkBootstrapCommandOptions')}
                        stepType={StepType.AwsCdkBootstrap}
                      />
                    </Container>
                  }
                />
...
export const AwsCDKBootstrapStepEditRef = React.forwardRef(AwsCDKBootstrapStepEdit)
