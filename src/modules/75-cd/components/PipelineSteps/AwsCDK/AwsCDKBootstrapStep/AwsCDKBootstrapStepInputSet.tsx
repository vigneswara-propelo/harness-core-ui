...
interface AwsCDKDiffStepInputSetProps {
  initialValues: AwsCDKDiffStepInitialValues
  allowableTypes: AllowedTypes
  inputSetData: {
    allValues?: AwsCDKDiffStepInitialValues
...
function AwsCDKBootstrapStepInputSet(props: AwsCDKDiffStepInputSetProps): React.ReactElement {
  ...
  return (
    <>
      ...
      <AwsCdkStepCommonOptionalFieldsInputSet
        commandOptionsLabel="cd.steps.awsCdkStep.awsCdkBootstrapCommandOptions"
        {...props}
...
export const AwsCDKBootstrapStepInputSetMode = connect(AwsCDKBootstrapStepInputSet)
