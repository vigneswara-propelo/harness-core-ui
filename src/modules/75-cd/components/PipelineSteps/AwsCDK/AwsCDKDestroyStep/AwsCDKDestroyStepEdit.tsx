...
export interface AwsCDKDestroyStepProps {
...
const AwsCDKDestroyStepEdit = (
  props: AwsCDKDestroyStepProps,
  ...
  return (
    <>
      <Formik<AwsCDKCommonStepFormikValues>
        ...
        formName="AwsCDKDestroyStepEdit"
          ...
          return (
            <FormikForm>
              ...
              <Accordion className={stepCss.accordion}>
                <Accordion.Panel
                  id="aws-cdk-destroy-optional-accordion"
                  data-testid={'aws-cdk-destroy-optional-accordion'}
                  ...
                  details={
                    <Container margin={{ top: 'medium' }}>
                      <AwsCdkCommonOptionalFieldsEdit
                        ...
                        commandOptionsFieldLabel={getString('cd.steps.awsCdkStep.awsCdkDestroyCommandOptions')}
...
export const AwsCDKDestroyStepEditRef = React.forwardRef(AwsCDKDestroyStepEdit)
