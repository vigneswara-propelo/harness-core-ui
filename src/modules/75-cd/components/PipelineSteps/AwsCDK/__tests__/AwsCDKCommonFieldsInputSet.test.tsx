...
import { AwsCdkStepCommonOptionalFieldsInputSet, AwsCdkStepInitialValues } from '../AwsCDKCommonFieldsInputSet'
...
const existingInitialValues: AwsCdkStepInitialValues = {
  identifier: 'Step_1',
  name: 'Step 1',
  spec: {
...
const awsCDKRuntimeTemplate: AwsCdkStepInitialValues = {
  identifier: 'Step_1',
  name: 'Step 1',
  spec: {
          ...
          <FormikForm>
            <TestWrapper path={PATH} pathParams={PATH_PARAMS}>
              <AwsCdkStepCommonOptionalFieldsInputSet
                inputSetData={{
                  readonly: readonly,
                  template: awsCDKRuntimeTemplate,
                  path: ''
                }}
...
describe('AwsCDKStepCommonOptionalFieldsInputSet tests', () => {
  beforeEach(() => {
    onUpdate.mockReset()
  })
  ...
  test('it should display Runtime input as initial values for all fields in edit view', async () => {
    ...
    const { container } = renderComponent({
      initialValues: awsCDKRuntimeTemplate as AwsCDKCommonStepFormikValues,
      readonly: false,
      formikRef: ref,
      onUpdateMocked: onUpdate
    })
