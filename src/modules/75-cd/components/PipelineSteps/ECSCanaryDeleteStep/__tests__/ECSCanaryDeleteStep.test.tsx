...
import { ECSCanaryDeleteStep } from '../ECSCanaryDeleteStep'

factory.registerStep(new ECSCanaryDeleteStep())

const existingInitialValues = { identifier: 'Step_1', name: 'Step 1', timeout: '20m', type: StepType.EcsCanaryDelete }
const onUpdate = jest.fn()
const onChange = jest.fn()

describe('ECSCanaryDeleteStep tests', () => {
  beforeEach(() => {
    onUpdate.mockReset()
    onChange.mockReset()
  })
      ...
      <TestStepWidget
        ...
        customStepProps={{
          ...
          metadataMap: {
            'Step 1': {
              yamlProperties: {
                fqn: 'pipeline.stages.qaStage.execution.steps.EcsCanaryDelete.name',
                localName: 'step.EcsCanaryDelete.name'
              }
            },
            '20m': {
              yamlProperties: {
                fqn: 'pipeline.stages.qaStage.execution.steps.EcsCanaryDelete.timeout',
                localName: 'step.EcsCanaryDelete.timeout'
              }
            }
          }
        }}
