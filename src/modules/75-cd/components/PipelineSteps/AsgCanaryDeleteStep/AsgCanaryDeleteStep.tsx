...
interface AsgCanaryDeleteStepVariableStepProps {
...
export class AsgCanaryDeleteStep extends PipelineStep<StepElementConfig> {
  ...
  renderStep(props: StepProps<StepElementConfig>): JSX.Element {
    ...
    if (this.isTemplatizedView(stepViewType)) {
      ...
      const { variablesData, metadataMap } = customStepProps as AsgCanaryDeleteStepVariableStepProps
      return (
        <VariablesListTable
    ...
    return (
      <GenericExecutionStepEditRef
        ...
        ref={formikRef}
        readonly={readonly}
        formikFormName={'AsgCanaryDeleteFormikForm'}
      />
    )
  }
