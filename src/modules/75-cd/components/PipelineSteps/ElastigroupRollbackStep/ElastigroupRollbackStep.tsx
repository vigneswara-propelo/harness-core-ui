...
interface ElastigroupRollbackVariableStepProps {
...
export class ElastigroupRollbackStep extends PipelineStep<StepElementConfig> {
  ...
  renderStep(props: StepProps<StepElementConfig>): JSX.Element {
    ...
    if (this.isTemplatizedView(stepViewType)) {
      ...
      const { variablesData, metadataMap } = customStepProps as ElastigroupRollbackVariableStepProps
      return (
        <VariablesListTable
    ...
    return (
      <GenericExecutionStepEditRef
        ...
        ref={formikRef}
        readonly={readonly}
        formikFormName={'ElastigroupRollbackStepForm'}
      />
    )
  }
