...
import { DeployCloudFunctionRollbackStep } from '../DeployCloudFunctionRollbackStep'
...
describe('DeployCloudFunctionRollbackStep tests', () => {
  beforeEach(() => {
    onUpdate.mockReset()
    onChange.mockReset()
  })
      ...
      <TestStepWidget
        ...
        customStepProps={{
          ...
          metadataMap: {
            'Step 1': {
              yamlProperties: {
                fqn: 'pipeline.stages.qaStage.execution.steps.CloudFunctionRollback.name',
                localName: 'step.CloudFunctionRollback.name'
              }
            },
            '20m': {
              yamlProperties: {
                fqn: 'pipeline.stages.qaStage.execution.steps.CloudFunctionRollback.timeout',
                localName: 'step.CloudFunctionRollback.timeout'
              }
            }
          }
        }}
