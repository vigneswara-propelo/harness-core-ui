...
export class DeployCloudFunctionStepGenOne extends PipelineStep<CloudFunctionExecutionStepInitialValues> {
  protected type = StepType.DeployCloudFunctionGenOne
  protected stepName = 'Deploy Cloud Function Gen One'
  protected stepIcon: IconName = 'deploy-cloud-function'
  protected stepDescription: keyof StringsMap = 'pipeline.stepDescription.DeployCloudFunctionGenOne'
  ...
  renderStep(props: StepProps<CloudFunctionExecutionStepInitialValues>): JSX.Element {
    ...
    return (
      <NoTrafficShiftExecutionStepEditRef
        formikFormName={'deployCloudFunctionStepGenOne'}
