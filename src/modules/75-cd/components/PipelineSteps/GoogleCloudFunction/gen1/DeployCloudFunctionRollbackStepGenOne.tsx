...
export class DeployCloudFunctionRollbackStepGenOne extends PipelineStep<StepElementConfig> {
  protected type = StepType.RollbackCloudFunctionGenOne
  protected stepName = 'Cloud Function Rollback Gen One'
  protected stepIcon: IconName = 'cloud-function-rollback'
  protected stepDescription: keyof StringsMap = 'pipeline.stepDescription.DeployCloudFunctionRollbackGenOne'
  ...
  renderStep(props: StepProps<StepElementConfig>): JSX.Element {
    ...
    return (
      <GenericExecutionStepEditRef
        formikFormName={'cloudFunctionRollbackStepGenOne'}
