...
export interface FetchInstanceScriptVariableViewProps {
  metadataMap: Record<string, VariableResponseMapValue>
  variablesData: StepElementConfig
  originalData: StepElementConfig
}

export function FetchInstanceScriptVariableView(props: FetchInstanceScriptVariableViewProps): React.ReactElement {
