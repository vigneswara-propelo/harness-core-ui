...
import { ServerlessAwsLambdaPrepareRollbackV2StepInitialValues } from '@pipeline/utils/types'
import { testConnectorRefChange } from '@cd/components/PipelineSteps/AwsSam/AwsSamInfraSpec/__tests__/helper'
import { ServerlessAwsLambdaPrepareRollbackV2Step } from '../ServerlessAwsLambdaPrepareRollbackV2Step'
import { ServerlessAwsLambdaPrepareRollbackV2StepFormikValues } from '../ServerlessAwsLambdaPrepareRollbackV2StepEdit'
...
const existingInitialValues: ServerlessAwsLambdaPrepareRollbackV2StepInitialValues = {
  identifier: 'Step_1',
  name: 'Step 1',
  spec: {
...
const awsSamDeployRuntimeTemplate: ServerlessAwsLambdaPrepareRollbackV2StepInitialValues = {
  identifier: 'Step_1',
  name: 'Step 1',
  spec: {
...
describe('ServerlessAwsLambdaPrepareRollbackV2Step tests', () => {
  beforeEach(() => {
    onUpdate.mockReset()
    onChange.mockReset()
  })
  ...
  test('it should create step with correct data', async () => {
    ...
    await waitFor(() =>
      expect(onChange).toHaveBeenLastCalledWith({
        identifier: 'ServerlessPrepareRollback_Step',
        name: 'ServerlessPrepareRollback Step',
        type: StepType.ServerlessAwsLambdaPrepareRollbackV2,
        timeout: '20m',
        spec: {
          connectorRef: 'account.Kubernetes_Connector_2',
  ...
  test('it should show errors for required fields when stepViewType is TriggerForm', async () => {
    ...
    const step = new ServerlessAwsLambdaPrepareRollbackV2Step()
      ...
      <TestStepWidget
        ...
        customStepProps={{
          ...
          metadataMap: {
            'Step 1': {
              yamlProperties: {
                fqn: 'pipeline.stages.qaStage.execution.steps.ServerlessAwsLambdaPrepareRollbackV2.name',
                localName: 'step.ServerlessAwsLambdaPrepareRollbackV2.name'
              }
            },
            '20m': {
              yamlProperties: {
                fqn: 'pipeline.stages.qaStage.execution.steps.ServerlessAwsLambdaPrepareRollbackV2.timeout',
                localName: 'step.ServerlessAwsLambdaPrepareRollbackV2.timeout'
              }
            }
          }
        }}
