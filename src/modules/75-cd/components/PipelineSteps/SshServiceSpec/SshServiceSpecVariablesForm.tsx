...
export interface SshServiceSpecVariablesFormProps {
...
export function SshServiceSpecVariablesForm(props: SshServiceSpecVariablesFormProps): React.ReactElement {
  ...
  return (
    <React.Fragment>
            ...
            !!manifestsVariables?.length && (
              <>
                {manifestsVariables?.map(({ manifest }, index) => (
                  <VariablesListTable
                    key={index}
                    className={cx(css.configFileVariablesTable, pipelineVariableCss.variablePaddingL3)}
      ...
      <NestedAccordionPanel
        ...
        summaryClassName={pipelineVariableCss.accordianSummaryL1}
        details={
