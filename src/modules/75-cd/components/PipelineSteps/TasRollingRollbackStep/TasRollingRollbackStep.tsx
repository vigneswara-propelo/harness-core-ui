...
interface TASRollbackStepVariableStepProps {
...
export class TASRollingRollbackStep extends PipelineStep<StepElementConfig> {
  ...
  renderStep(props: StepProps<StepElementConfig>): JSX.Element {
    ...
    if (this.isTemplatizedView(stepViewType)) {
      ...
      const { variablesData, metadataMap } = customStepProps as TASRollbackStepVariableStepProps
      return (
        <VariablesListTable
    ...
    return (
      <GenericExecutionStepEditRef
        ...
        ref={formikRef}
        readonly={readonly}
        formikFormName="TasRollingRollbackForm"
      />
    )
  }
