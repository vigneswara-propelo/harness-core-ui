...
describe('Nexus Artifact Source tests', () => {
  test('test for Primary Nexus artifact source', async () => {
    ...
    expect(await findByText('pipeline.artifactsSelection.classifier')).toBeInTheDocument()
    expect(await findByText('pipeline.artifactsSelection.extension')).toBeInTheDocument()
    expect(await findByText('pipeline.artifactsSelection.groupId')).toBeInTheDocument()
    expect(await findByText('pipeline.artifactsSelection.artifactId')).toBeInTheDocument()
  })

  test('test for Sidecar Nexus artifact source', async () => {
    const { findByText } = render(
      <TestWrapper>
