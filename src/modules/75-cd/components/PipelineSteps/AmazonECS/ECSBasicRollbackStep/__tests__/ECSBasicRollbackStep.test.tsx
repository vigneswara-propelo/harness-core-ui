...
import { ECSBasicRollbackStep } from '../ECSBasicRollbackStep'
...
describe('ECSBasicRollbackStep tests', () => {
  beforeEach(() => {
    onUpdate.mockReset()
    onChange.mockReset()
  })
      ...
      <TestStepWidget
        ...
        customStepProps={{
          ...
          metadataMap: {
            'Step 1': {
              yamlProperties: {
                fqn: 'pipeline.stages.qaStage.execution.steps.EcsBasicRollback.name',
                localName: 'step.EcsBasicRollback.name'
              }
            },
            '20m': {
              yamlProperties: {
                fqn: 'pipeline.stages.qaStage.execution.steps.EcsBasicRollback.timeout',
                localName: 'step.EcsBasicRollback.timeout'
              }
            }
          }
        }}
