...
interface ECSBasicRollbackVariableStepProps {
...
export class ECSBasicRollbackStep extends PipelineStep<StepElementConfig> {
  protected type = StepType.EcsBasicRollback
  protected stepName = 'ECS Rollback'
  protected stepIcon: IconName = 'undo'
  protected stepDescription: keyof StringsMap = 'pipeline.stepDescription.ECSRollback'
  protected isHarnessSpecific = false
  protected defaultValues: StepElementConfig = {
    identifier: '',
    name: '',
    type: StepType.EcsBasicRollback,
    timeout: '10m'
  }
  ...
  renderStep(props: StepProps<StepElementConfig>): JSX.Element {
    ...
    if (this.isTemplatizedView(stepViewType)) {
      ...
      const { variablesData, metadataMap } = customStepProps as ECSBasicRollbackVariableStepProps
      return (
        <VariablesListTable
    ...
    return (
      <GenericExecutionStepEditRef
        ...
        ref={formikRef}
        readonly={readonly}
        formikFormName={'ecsRollbackStepForm'}
      />
    )
  }
