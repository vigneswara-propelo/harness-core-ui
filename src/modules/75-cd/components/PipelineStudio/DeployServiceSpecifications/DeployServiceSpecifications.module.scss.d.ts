...
declare const styles: {
  readonly cdFirstGenTrialContent: string
  readonly cdGenerationContent: string
  readonly cdGenerationSelectionTooltip: string
  readonly cdGenerationSwitchContainer: string
  ...
  readonly recentDeploymentTemplates: string
