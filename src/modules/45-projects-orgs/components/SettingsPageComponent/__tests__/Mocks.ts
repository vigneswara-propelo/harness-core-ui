...
export const projectMockDataWithModules = {
  ...
  data: {
    projectResponse: {
      ...
      createdAt: 1697537677996,
      lastModifiedAt: 1697537677996,
      isFavorite: false
    },
    organization: {
      identifier: 'default',
    ...
    admins: [
      {
        name: 'Shubhendu Patidar',
        email: 'shubhendu.patidar@harness.io',
        uuid: '1Z0WMMaNS8SdboN2NyuIwg',
        locked: false,
        disabled: false,
  ...
  metaData: null,
  correlationId: '3ca6f8da-1478-47ac-9bb6-908ae3db1ee5'
}
