...
describe('Project Settings Page', () => {
  test('should render project settings page', async () => {
    ...
    expect(queryByText('common.agents')).toBeInTheDocument()
    expect(queryByText('common.purpose.errorTracking.agentTokens')).toBeInTheDocument()
    expect(queryByText('common.purpose.errorTracking.criticalEvents')).toBeInTheDocument()
