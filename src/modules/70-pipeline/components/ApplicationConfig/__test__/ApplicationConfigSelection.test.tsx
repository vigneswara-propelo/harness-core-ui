...
import { fetchConnectors, mockErrorHandler, props } from './ApplicationConfigTestUtils'
...
describe('ApplicationConfigSelection', () => {
  test('initial render', async () => {
    const { container } = render(
      <TestWrapper path={testPath} pathParams={testPathParams}>
        <PipelineContext.Provider value={getContextValue()}>
          <ApplicationConfigSelection {...props} showApplicationSettings={true} showConnectionStrings={true} />
