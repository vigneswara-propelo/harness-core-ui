...
import {
  ...
  prevStepDataRuntime,
  propStepTwo
} from './ApplicationConfigTestUtils'
...
describe('ApplicationConfigWizardStepTwo', () => {
  test('move to stepTwo', async () => {
    ...
    const { container } = render(
      <TestWrapper>
        <ApplicationConfigWizardStepTwo
          {...propStepTwo}
  ...
  test('load empty and go back', async () => {
    const { container } = render(
      <TestWrapper>
        <ApplicationConfigWizardStepTwo {...propStepTwo} initialValues={{} as any} previousStep={onBack} />
      </TestWrapper>
    )
