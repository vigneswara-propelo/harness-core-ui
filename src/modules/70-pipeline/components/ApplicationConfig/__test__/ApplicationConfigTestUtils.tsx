...
export const props: ApplicationConfigSelectionProps = {
  isPropagating: true,
...
export const connectionStrings = { ...branchStore }
...
const stepDetails = <ApplicationConfigWizardStepTwo {...propStepTwo} />
