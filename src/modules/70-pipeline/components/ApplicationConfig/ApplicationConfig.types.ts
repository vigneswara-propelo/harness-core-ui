...
export interface ApplicationCofigDataType {
...
export interface ApplicationConfigListViewProps {
  ...
  selectionType: ApplicationConfigSelectionTypes
...
export interface ApplicationConfigWizardStepsProps<T> {
  handleConnectorViewChange: (isConnectorView: boolean) => void
  initialValues: ApplicationConfigWizardInitData
...
export interface ApplicationConfigWizardStepOneProps {
  stepName: string
  expressions: string[]
  allowableTypes: MultiTypeAllowedTypes
  isReadonly: boolean
...
export interface ApplicationConfigWizardStepTwoProps {
  stepName: string
  expressions: string[]
  allowableTypes: MultiTypeAllowedTypes
  initialValues: ApplicationSettingsConfiguration | ConnectionStringsConfiguration
...
export interface ApplicationConfigSelectionProps {
  isPropagating?: boolean
  deploymentType?: ServiceDefinition['type']
  isReadonlyServiceMode?: boolean
  readonly: boolean
...
export enum ApplicationConfigSelectionTypes {
  PIPELINE = 'PIPELINE',
