...
export const PipelineContextV1 = React.createContext<PipelineContextInterface>({
  state: initialState,
...
export function usePipelineContextV1(): PipelineContextInterface {
  // disabling this because this the definition of usePipelineContext
  // eslint-disable-next-line no-restricted-syntax
  return React.useContext(PipelineContextV1)
}
