...
import { savePipeline, usePipelineContextV1 } from '../PipelineContextV1/PipelineContextV1'

import css from '@pipeline/components/PipelineStudio/SavePipelinePopover/SavePipelinePopover.module.scss'
...
export type SavePipelineHandleV1 = {
...
function SavePipelinePopoverV1(
  props: SavePipelinePopoverProps,
  ref: React.ForwardedRef<SavePipelineHandleV1>
): React.ReactElement {
  ...
  React.useImperativeHandle(
    ...
    () => ({
      updatePipeline: async (pipelineYaml: string) => {
        await initPipelinePublish(parse<PipelineInfoConfig>(pipelineYaml))
      }
    }),
    [initPipelinePublish]
  )
...
export const SavePipelinePopoverWithRefV1 = React.forwardRef(SavePipelinePopoverV1)
